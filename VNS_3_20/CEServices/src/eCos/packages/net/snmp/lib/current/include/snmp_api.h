...
/* peter, 2007/7, upgrade to new version 1.100.2.2 */
...
/*	t_union *unionVal; */
    ...
    void *data;			/* peter, 2007/7, upgrade to new version 1.100.2.2 */
    int  index;			/* peter, 2007/7, upgrade to new version 1.100.2.2 */
};
...
struct snmp_session *snmp_open_v6 (struct snmp_session *);
...
#define TIMED_OUT	   2
#define SEND_FAILED	   3 /* peter, 2007/7, upgrade to new version 1.100.2.2 */
#define DELETE_SESSION	   4 /* Sgetz, 2012/7 */
...
#ifdef CYGPKG_NET_FREEBSD_INET6
u_char *snmp_pdu_build_v6 (struct snmp_pdu *, u_char *, size_t *);
#endif /* CYGPKG_NET_FREEBSD_INET6 */
...
int snmp_pdu_parse(struct snmp_pdu *pdu, u_char *data, size_t *length, int *af_family);
...
#ifdef CYGPKG_NET_FREEBSD_INET6
struct snmp_session *snmp_open_ex_v6 (struct snmp_session *,
  int (*fpre_parse) (struct snmp_session *, snmp_ipaddr),
  int (*fparse) (struct snmp_session *, struct snmp_pdu *, u_char *, size_t),
  int (*fpost_parse) (struct snmp_session *, struct snmp_pdu *, int),
  int (*fbuild) (struct snmp_session *, struct snmp_pdu *, u_char *, size_t *),
...
#ifdef CYGPKG_NET_FREEBSD_INET6
void * snmp_sess_open_v6    (struct snmp_session *);
#endif /* CYGPKG_NET_FREEBSD_INET6 */
