...
#define CYG_TFTP_MSEC2TICK(msec) (msec / (CYGNUM_HAL_RTC_NUMERATOR / CYGNUM_HAL_RTC_DENOMINATOR / 1000000))
...
tftpd_stop(int p)
{
    ...
    if (server->tag == TFTP_tag) {
        ...
        cyg_thread_delay(CYG_TFTP_MSEC2TICK(10));  // Make sure it gets to die...
