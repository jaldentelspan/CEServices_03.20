...
lldp_bool_t lldpmed_validate_lldpdu(lldp_8_t   *tlv, lldp_rx_remote_entry_t   *rx_entry, lldp_u16_t len, lldp_bool_t first_lldpmed_tlv)
{
    ...
    if (memcmp(org_oui, &LLDP_TLV_OUI_TIA[0], 3) == 0) {
            ...
            for (p_index = 0; p_index < MAX_LLDPMED_LOCATION_CNT; p_index ++) {
                ...
                if (rx_entry->lldpmed_location_vld[p_index] == 1) {
                    ...
                    if (rx_entry->lldpmed_location_format[p_index] == 1 &&
                        ...
                        T_W("Invalid LLDP location length / format, length = %u ", rx_entry->lldpmed_location_length[p_index]);
                        rx_entry->lldpmed_location_vld[p_index] = 0; // Store that this location field isn't used.
        ...
        case 0x04: // Subtype PoE - See Figure 12 in TIA1057
            ...
            T_WG(TRACE_GRP_MED_RX, "Unexpected PoE TLV");
            org_tlv_supported = FALSE;
            break;
        ...
        case 0x5:
            ...
            if (len >= 4) {
                ...
                T_E("Hardware revision TLV length too short");
            }
        ...
        case 0x6:
            ...
            if (len >= 4) {
                ...
                T_E("Firmware revision TLV length too short");
            }
        ...
        case 0x7:
            ...
            if (len >= 4) {
                ...
                T_E("Software revision TLV length too short");
            }
        ...
        case 0x8:
            ...
            if (len >= 4) {
                ...
                T_E("Serial number TLV length too short");
            }
        ...
        case 0x9:
            ...
            if (len >= 4) {
                ...
                T_E("Manufacturer name TLV length too short");
            }
        ...
        case 0xA:
            ...
            if (len >= 4) {
                ...
                T_E("Model name TLV length too short");
            }
        ...
        case 0xB:
            ...
            if (len >= 4) {
                ...
                T_E("Assert ID TLV length too short");
            }
