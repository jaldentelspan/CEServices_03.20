...
#include "icli_types.h" // For icli_stack_port_range_t
 ...
 * \param reinit [IN] The new value to be set.
 * \param no [IN] TRUE if the no command is use
 * \return None.
 **/
void lldp_icli_global_conf(BOOL holdtime, BOOL timer, BOOL reinit, u16 new_val, BOOL no);
 ...
 * \return None.
 **/
void lldp_icli_prio(BOOL interface, icli_stack_port_range_t *port_list, u8 prio, BOOL no);
 ...
 * \return None.
 **/
void lldp_icli_mode(icli_stack_port_range_t *port_list, BOOL tx, BOOL rx, BOOL no);
