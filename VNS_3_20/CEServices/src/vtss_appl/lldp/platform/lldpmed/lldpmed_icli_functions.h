 ...
 * \return None.
 **/
void lldpmed_icli_civic_addr(i32 session_id, BOOL has_country, BOOL has_state, BOOL has_county, BOOL has_city, BOOL has_district,
 ...
 * \param list [IN]  Port list in case user has specified a specific interface.
 * \return None.
 **/
void lldpmed_icli_show_remote_device(i32 session_id, BOOL has_interface, icli_stack_port_range_t *list);

/**
 * \brief Function for showing lldp polices
 *
 * \param session_id [IN]  The session id.
 ...
 *
 * \param list  [IN]  Port list with ports to configure.
 ...
 * \param no [IN] TRUE to set policy to the default value.
 * \param v_0_to_7 [IN] L2 Priority value
 * \param v_0_to_63 [IN] DSCP value
 * \return None.
 **/
void lldpmed_icli_media_vlan_policy(i32 session_id, u32 index, BOOL has_voice, BOOL has_voice_signaling, BOOL has_guest_voice_signaling,
 ...
 *
 * \param session_id [IN]  The session id.
 * \param port_list [IN] List of port to assign the policies to.
 * \param policy_list [IN] List of policies to assign to the given ports.
 * \return None.
 **/
void lldpmed_icli_assign_policy(i32 session_id, icli_stack_port_range_t *port_list, icli_range_t *policy_list, BOOL no);
