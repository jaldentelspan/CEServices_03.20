...
vtss_rc vtss_dhcp_client_ip_get(vtss_vid_t           vlan,
                                vtss_ipv4_network_t *v1)
{
    DHCP_CLIENT_CRIT_ENTER();
    DHCP_CLIENT_CRIT_RETURN_RC(pool.ip_get(vlan, v1));
}
...
{
    DHCP_CLIENT_CRIT_ENTER();
    DHCP_CLIENT_CRIT_RETURN_RC(pool.option_get(vlan, v1, v2, v3));
}

vtss_rc vtss_dhcp_client_option_ip_any_get(u8           option_code,
                                           vtss_ipv4_t  prefered,
                                           vtss_ipv4_t *ip)
{
    DHCP_CLIENT_CRIT_ENTER();
    DHCP_CLIENT_CRIT_RETURN_RC(pool.option_ip_any_get(option_code, prefered, ip));
}

vtss_rc vtss_dhcp_client_option_ip_get(vtss_vid_t   vlan,
                                       u8           v1,
                                       vtss_ipv4_t *v2)
{
    DHCP_CLIENT_CRIT_ENTER();
    DHCP_CLIENT_CRIT_RETURN_RC(pool.option_ip_get(vlan, v1, v2));
}

vtss_rc vtss_dhcp_client_option_ipn_get(vtss_vid_t   vlan,
                                        u8           v1,
                                        u8           v2,
                                        vtss_ipv4_t *v3)
{
    DHCP_CLIENT_CRIT_ENTER();
    DHCP_CLIENT_CRIT_RETURN_RC(pool.option_ipn_get(vlan, v1, v2, v3));
}
