                                               ...
                                               vtss_icfg_query_result_t *result)
{
    ...
    for (idx = VTSS_VID_DEFAULT; idx < VTSS_VIDS; idx++) {
        // get configuration
...
vtss_rc arp_inspection_icfg_init(void)
{
    ...
    */
    if ((rc = vtss_icfg_query_register(VTSS_ICFG_ARP_INSPECTION_GLOBAL_CONF, ARP_INSPECTION_ICFG_global_conf)) != VTSS_OK) {
        return rc;
    }

    rc = vtss_icfg_query_register(VTSS_ICFG_ARP_INSPECTION_PORT_CONF, ARP_INSPECTION_ICFG_port_conf);
