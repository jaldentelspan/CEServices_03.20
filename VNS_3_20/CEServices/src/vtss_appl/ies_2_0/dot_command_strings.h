...
#define ENCODER_CH7_REGISTER_MAP_STRING   \
"\n\n/**************************************" \
"\n * CH7 ENCODER BIT MASKS" \
"\n **************************************/" \
"\nSTATUS" \
"\n    AVMM_TIMEOUT          (0x80000000)" \
"\n" \
"\nCTRL                      (0x3)" \
"\n    FRAME_SIZE_MASK       (0x0000000F)" \
"\n    FRAME_SIZE_SHFT       (0)" \
"\n    ENABLE_BIT            (0x00000080)" \
"\n    REMOVE_TSE_PADDING    (0x00000100)" \
"\n    INVERT_CLK            (0x00000200)" \
"\n    REMOVE_FCS            (0x01000000)" \
"\nPORT_SELECT               (0x4)" \
"\n    PORT_SELECT_MASK      (0x000000FF)" \
"\n    PORT_SELECT_SHFT      (0)" 


#define DECODER_CH7_REGISTER_MAP_STRING   \
"\n\n/**************************************" \
"\n * CH7 DECODER BIT MASKS" \
"\n **************************************/" \
"\nSTATUS" \
"\n    ILLEGAL_FRAME_SZ    (0x00000001) " \
"\n    AVST_ERROR          (0x00000002) " \
"\n    START_OF_MAJOR      (0x00000004) " \
"\n    MISSED_CH7_SYNC     (0x00000008) " \
"\n    GOLAY_ERROR         (0x00000010) " \
"\n    FRAME_LOCK          (0x00000020) " \
"\n    SFID_CAPTURE        (0x00000100) " \
"\n    AVMM_TIMEOUT        (0x80000000) " \
"\nCONTROL " \
"\n    FRAME_SIZE_MASK       (0x0000000F) /* 223*THIS VALUE */ " \
"\n    FRAME_SIZE_SHFT       (0) " \
"\n    TSE_PAD_EN_BIT        (0x00000010) " \
"\n    REMOVE_FCS_BIT        (0x00000040) " \
"\n    ENABLE_BIT            (0x00000080) " \
"\n    TSE_SHFT_EN           (0x00080000) " \
"\n    ETH_HDR_ADD_EN        (0x00100000) " \
"\n    ETH_CSDW_HDR_ADD_EN   (0x00200000) " \
"\n    ETH_SEC_HDR_ADD_EN    (0x00400000) " \
"\n    ETH_STRM_HDR_ADD_EN   (0x00800000) " \
"\n    CH10_HDR_ADD_EN       (0x01000000) " \
"\n    CH10_CSDW_HDR_ADD_EN  (0x02000000) " \
"\n    CH10_SEC_HDR_ADD_EN   (0x04000000) " \
"\n    CH10_STRM_HDR_ADD_EN  (0x08000000) " \
"\n    INVERT_CLOCK          (0x10000000) " \
"\n    SOFT_RESET            (0x80000000) " \
"\nPORT_SELECT " \
"\n    ENABLE         (0x00000080) " \
"\n    MASK           (0x00000003) " \
"\n    FIXED_CH10     (0x00000001) " \
"\n    FIXED_ETH      (0x00000002) " \
"\nCOUNTER " \
"\n    MASK               (0xFFFFFFFF) " \
...
#define DOT_CMD_STR_EPE_ARGS         "[encode|decode] [hdlc|ch7|disable] [<bit_rate>] [<ch7_word_count>] [invert_clock] [remove_fcs]"
...
#define DOT_CMD_STR_EPE_MULTI        ".EPE TimeDivision"
...
#define DOT_CMD_STR_EPE_ENC_STAT         ".EPE encoder status"
#define DOT_CMD_STR_EPE_ENC_STAT_ARGS    ""
#define DOT_CMD_STR_EPE_ENC_STAT_DESC    "Show the EPE encode status " ENCODER_CH7_REGISTER_MAP_STRING
#define DOT_CMD_STR_EPE_ENC_STAT_CMD     DOT_CMD_STR_EPE_ENC_STAT " " DOT_CMD_STR_EPE_ENC_STAT_ARGS
#define DOT_CMD_STR_EPE_ENC_STAT_FUNC    cli_cmd_epe_encoder_status

#define DOT_CMD_STR_EPE_DEC_STAT         ".EPE decoder status"
#define DOT_CMD_STR_EPE_DEC_STAT_ARGS    ""
#define DOT_CMD_STR_EPE_DEC_STAT_DESC    "Show the EPE decode status" DECODER_CH7_REGISTER_MAP_STRING
#define DOT_CMD_STR_EPE_DEC_STAT_CMD     DOT_CMD_STR_EPE_DEC_STAT " " DOT_CMD_STR_EPE_DEC_STAT_ARGS
#define DOT_CMD_STR_EPE_DEC_STAT_FUNC    cli_cmd_epe_decoder_status
...
#define IES_DEBUG_CMD_STR_I2C_READ_ARGS    "<i2c_reg> <i2c_offset>" 
...
#define IES_DEBUG_CMD_STR_I2C_WRITE_ARGS   "<i2c_reg> <i2c_offset> <i2c_data_word>" 
...
#define IES_DEBUG_CMD_STR_EPE_PORT_ARGS    "[encode|decode|full_duplx|disable] [hdlc|ch7] [<bit_rate>] [<ch7_word_count>] [invert_clock] [remove_fcs]"
...
#define IES_DEBUG_CMD_STR_LED_TEST          "Debug ies led" 
#define IES_DEBUG_CMD_STR_LED_TEST_ARGS      "<red_blue> <green> <flashing> <discrete_out>" 
/* #define IES_DEBUG_CMD_STR_LED_TEST_ARGS      "<red_blue>"  */
#define IES_DEBUG_CMD_STR_LED_TEST_DESC      "Debug ies led test"
#define IES_DEBUG_CMD_STR_LED_TEST_CMD       IES_DEBUG_CMD_STR_LED_TEST " " IES_DEBUG_CMD_STR_LED_TEST_ARGS
#define IES_DEBUG_CMD_STR_LED_TEST_FUNC      FPGA_dot_led_test   

#define IES_DEBUG_CMD_STR_TIME_IN_REG           "Debug ies timin reg" 
#define IES_DEBUG_CMD_STR_TIME_IN_REG_ARGS      "" 
#define IES_DEBUG_CMD_STR_TIME_IN_REG_DESC      "Debug ies timin reg"
#define IES_DEBUG_CMD_STR_TIME_IN_REG_CMD       IES_DEBUG_CMD_STR_TIME_IN_REG " " IES_DEBUG_CMD_STR_TIME_IN_REG_ARGS
#define IES_DEBUG_CMD_STR_TIME_IN_REG_FUNC      debug_time_input_reg   

#define IES_DEBUG_CMD_STR_ENCODER_REG           "Debug ies encoder reg" 
#define IES_DEBUG_CMD_STR_ENCODER_REG_ARGS      "" 
#define IES_DEBUG_CMD_STR_ENCODER_REG_DESC      "Debug ies encoder reg"
#define IES_DEBUG_CMD_STR_ENCODER_REG_CMD       IES_DEBUG_CMD_STR_ENCODER_REG " " IES_DEBUG_CMD_STR_ENCODER_REG_ARGS
#define IES_DEBUG_CMD_STR_ENCODER_REG_FUNC      debug_encoder_reg   

#define IES_DEBUG_CMD_STR_DECODER_REG           "Debug ies decoder reg" 
#define IES_DEBUG_CMD_STR_DECODER_REG_ARGS      "" 
#define IES_DEBUG_CMD_STR_DECODER_REG_DESC      "Debug ies decoder reg"
