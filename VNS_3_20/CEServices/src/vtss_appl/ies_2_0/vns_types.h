...
#define VNS_EPE_BIT_RATE_MIN    200000
#define VNS_EPE_BIT_RATE_MAX    50000000
...
#define IES_DEFAULT_CLOCK_INST (0)
...
#define VNS_PORT_COUNT		16
#define HIDE_IRIG_INPUTS	0
#define MODEL_NAME "iES-16"
#define VNS_MAC_PRODUCT_ID (0x1E)
...
#define VNS_VERSION_MAJOR   20260416   
#define VNS_VERSION_MINOR   111805 
...
typedef enum{
    ...
    DO_SETTING_P13_ACTIVITY,
    DO_SETTING_P14_ACTIVITY,
    DO_SETTING_P15_ACTIVITY,
    DO_SETTING_P16_ACTIVITY,
    DO_SETTING_P1_LINK,
    DO_SETTING_P2_LINK,
    DO_SETTING_P3_LINK,
    DO_SETTING_P4_LINK,
...
typedef enum {
    ...
    TIME_INPUT_SRC_1588      = 0x06,
    TIME_INPUT_SRC_802_1AS   = 0x07,
    TIME_INPUT_SRC_GPS0      = 0x08,
    TIME_INPUT_SRC_GPS3      = 0x09,
    TIME_INPUT_SRC_GPS5      = 0x0A,
    TIME_INPUT_SRC_INTERNAL  = 0x0B,
    TIME_INPUT_SRC_1PPS      = 0x0C,
    TIME_INPUT_SRC_DISABLED  = 0x0D,
...
typedef enum{
	...
	IEEE_1588_SLAVE,
	IEEE_1588_MASTER,
        IEEE_1588_802_1AS_SLAVE,
        IEEE_1588_802_1AS_MASTER
}vns_1588_type;
...
typedef enum {
    ...
    VNS_EPE_FULLDPX_HDLC   = 0x05,
    VNS_EPE_FULLDPX_CH7_15 = 0x06,
    VNS_EPE_END
} vns_epe_mode_t;
...
typedef struct {
    ...
    BOOL invert_clock;
    BOOL insert_fcs;
    u8   reserved; /*for 32 bit alignment */
} vns_epe_conf_blk_t;
