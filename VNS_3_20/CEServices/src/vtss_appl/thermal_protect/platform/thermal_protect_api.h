...
// Functions
//************************************************
void    thermal_protect_mgmt_get_switch_conf(thermal_protect_local_conf_t *local_conf, vtss_isid_t isid);
vtss_rc thermal_protect_mgmt_set_switch_conf(thermal_protect_local_conf_t *new_local_conf, vtss_isid_t isid);
