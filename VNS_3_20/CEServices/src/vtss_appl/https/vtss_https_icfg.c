                                           ...
                                           vtss_icfg_query_result_t *result)
{
    ...
    conf     = (https_conf_t *) malloc(sizeof(https_conf_t));
    def_conf = (https_conf_t *) malloc(sizeof(https_conf_t));
...
vtss_rc vtss_https_icfg_init(void)
{
    ...
    return vtss_icfg_query_register(VTSS_HTTPS_ICFG_GLOBAL_CONF, VTSS_HTTPS_ICFG_global_conf);
}
