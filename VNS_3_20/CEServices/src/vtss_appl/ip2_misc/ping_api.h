...
/* Main ping entry point - ICLI version */
BOOL ping_start(i32 session, const char *ip_address, i32 len, i32 count, i32 interval);
...
#ifdef VTSS_SW_OPTION_ICLI
/* Main ping6 entry point - ICLI version */
BOOL ping6_start(i32 session, const vtss_ipv6_t *ipv6_address, i32 len, i32 count, i32 interval);
#endif /* VTSS_SW_OPTION_ICLI */
