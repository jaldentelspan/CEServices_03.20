...
#define LOCK_TRACE_LEVEL VTSS_TRACE_LVL_NOISE
//#define TOD_CORE_LOCK()        critd_enter(&ptp_global.coremutex, VTSS_TRACE_GRP_DEFAULT, LOCK_TRACE_LEVEL, __FILE__, __LINE__)
//#define TOD_CORE_UNLOCK()      critd_exit (&ptp_global.coremutex, VTSS_TRACE_GRP_DEFAULT, LOCK_TRACE_LEVEL, __FILE__, __LINE__)
