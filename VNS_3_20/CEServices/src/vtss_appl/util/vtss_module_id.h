...
const char * const vtss_module_names[VTSS_MODULE_ID_NONE+1] =
{
    ...
    [VTSS_MODULE_ID_IPMC_LIB]           = "IPMC_Profile",
    ...
    [VTSS_MODULE_ID_VNS_FPGA]           = "VNS_FPGA",
    [VTSS_MODULE_ID_MITR_FPGA]          = "MITR_FPGA",
    [VTSS_MODULE_ID_GVCP]               = "GVCP",
    [VTSS_MODULE_ID_IES_2_0]            = "IES_2_0",
...
#endif
#if defined(VTSS_MODULE_OPTION_VNS_FPGA)
    [VTSS_MODULE_ID_VNS_FPGA]		= 0,
#else
    [VTSS_MODULE_ID_VNS_FPGA]		= 1,
#endif
#if defined(VTSS_MODULE_OPTION_MITR_FPGA)
    [VTSS_MODULE_ID_MITR_FPGA]		= 0,
#else
    [VTSS_MODULE_ID_MITR_FPGA]		= 1,
#endif
#if defined(VTSS_MODULE_OPTION_GVCP)
    [VTSS_MODULE_ID_GVCP]			= 0,
#else
    [VTSS_MODULE_ID_GVCP]			= 1,
#endif
#if defined(VTSS_MODULE_OPTION_IES_2_0)
    [VTSS_MODULE_ID_IES_2_0]		= 0,
#else
    [VTSS_MODULE_ID_IES_2_0]		= 1,
#endif
