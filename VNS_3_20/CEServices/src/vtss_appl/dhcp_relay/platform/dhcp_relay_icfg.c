...
#define DHCP_RELAY_ICFG_REG(x, y, z)    (((x) = vtss_icfg_query_register((y), (z))) == VTSS_OK)
...
vtss_rc dhcp_relay_icfg_init(void)
{
    ...
    if (DHCP_RELAY_ICFG_REG(rc, VTSS_ICFG_DHCP_RELAY_CONFIG, dhcp_relay_icfg_global_ctrl)) {
