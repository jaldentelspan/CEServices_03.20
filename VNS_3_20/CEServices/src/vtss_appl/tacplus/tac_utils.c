#include <stdarg.h>
#ifndef TAC_PLUS_ESTAX34
#include <syslog.h>
#endif /* TAC_PLUS_ESTAX34 */
#include <stdio.h>
#include <stdlib.h>
...
/*
/////////////////////////////////////////////
// сверяем пароль, полученный от NASа с паролем
// полученным из базы. Если не проходит прямое сравнение
// делаем сравнение по MD5 digest (для CHAP)
//
