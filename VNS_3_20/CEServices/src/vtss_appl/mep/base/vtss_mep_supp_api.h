/*
 ...
 $Id: vtss_mep_supp_api.h,v 1.31 2011/03/16 12:24:06 henrikb Exp $
 $Revision: 1.31 $
...
#define VTSS_MEP_SUPP_RAPS_DATA_LENGTH    8
#define VTSS_MEP_SUPP_MAC_LENGTH          6
#define VTSS_MEP_SUPP_MEG_CODE_LENGTH     9
...
#define  VTSS_MEP_SUPP_FLOW_MASK_VID      0x0040
#define  VTSS_MEP_SUPP_FLOW_MASK_EVC_ID   0x0080
#define  VTSS_MEP_SUPP_FLOW_MASK_PATH     0x0100
#define  VTSS_MEP_SUPP_FLOW_MASK_PATH_P   0x0200
#define  VTSS_MEP_SUPP_FLOW_MASK_PORT_UNI 0x0400
...
typedef enum
{
    ...
    VTSS_MEP_SUPP_IEEE_STR    /* MEG-ID is IEEE Domain Name format as described in 802.1ag 21.6.5 - Domain format '4' and Short format '2' (Character string) */
...
typedef struct
{
    ...
    char                     name[VTSS_MEP_SUPP_MEG_CODE_LENGTH];    /* Domain Name or ITU Carrier Code (ICC). (string \0 terminated)   */
...
typedef enum
{
    VTSS_MEP_SUPP_STANDARDIZE,      /* DMM/DMR the standadized way */
    VTSS_MEP_SUPP_PROPRIETARY       /* DMM/DMR where DMR transmission TS is in follow up PDU */
} vtss_mep_supp_txway_t;
...
/* Modify/add this for DMM */
    ...
    u32                      gap;                               /* Gap between DMM in 10 ms.                      */ 
    vtss_mep_supp_txway_t    txway;                             /* Transmission way                               */
    vtss_mep_supp_tunit_t    tunit;                             /* Time resolution                                */
    vtss_mep_supp_act_t      act;                               /* Action when counter overflow                   */
    BOOL                     dm2fordm1;                         /* Calculate one-way delays when receiving DMR    */ 
...
/* Modify/add this for 1DM */
    ...
    u32                      prio;                             /* Priority                                        */
    u8                       dmac[VTSS_MEP_SUPP_MAC_LENGTH];   /* DMM destination MAC                             */
    u32                      gap;                              /* Gap between 1DM in 10 ms.                       */
    vtss_mep_supp_txway_t    txway;                            /* Transmission way                                */                        
    vtss_mep_supp_tunit_t    tunit;                            /* Time resolution                                 */
    vtss_mep_supp_act_t      act;                              /* Action when counter overflow                    */ 
...
typedef vtss_timestamp_t vtss_mep_supp_timestamp_t;
...
typedef struct
{
    vtss_mep_supp_timestamp_t   tx_time;                           /* DMM transmit time  */
    vtss_mep_supp_timestamp_t   rx_time;                           /* DMM receive time returned in DMR */
...
{
    u32                         transaction_id;
    vtss_mep_supp_mode_t        mode;
    vtss_mep_supp_direction_t   direction;
    u8                          ttl;
    BOOL                        relayed;
...
#define VTSS_MEP_SUPP_TST_SIZE_MAX  1518
#define VTSS_MEP_SUPP_TST_SIZE_MIN  64
#if defined(VTSS_ARCH_SERVAL)
#define VTSS_MEP_SUPP_TST_RATE_MAX  1000
#else
#define VTSS_MEP_SUPP_TST_RATE_MAX  400
#endif
typedef struct
{
    ...
    u32                     rate;                             /* The transmission rate in Mbps - max VTSS_MEP_SUPP_TST_RATE_MAX - min 1                                 */
...
/* This function is called white received OAM PDU frames */
...
typedef void (*vtss_mep_supp_cb_t)(u32 instance,  u8 *frame,  vtss_mep_supp_timestamp_t tx_time,  u64 frame_count);
typedef struct
{
    u32                     instance;
...
/* Control the host loop on the port */
void vtss_mep_supp_port_loop(const u32       instance,
                             const u32       port,
                             const BOOL      enable);

/* Get the active port in the port protection - if any */
