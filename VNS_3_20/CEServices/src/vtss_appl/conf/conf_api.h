...
typedef struct {
    ...
    int   board_type;
/* #if defined (BOARD_VNS_12_REF ) */
    ulong ies_board[IES_FLASH_CONF_ITEMS];
/* #endif */
} conf_board_t;
...
typedef enum {
    ...
    CONF_BLK_PVLAN_ISOLATE_TABLE, /*20*/
    CONF_BLK_SYSTEM,
    ...
    CONF_BLK_SNMP_RMON_ALARM_TABLE, /*30*/
    ...
    CONF_BLK_VCL_PROTO_VLAN_VID_TABLE, /*80*/
    ...
    CONF_BLK_MLDSNP_CONF,
    CONF_BLK_OS_FILE_CONF,
    CONF_BLK_ICLI,
    CONF_BLK_TRAP_CONF,
    CONF_BLK_SNTP_CONF,
    CONF_BLK_VNS_FPGA_CONF,/*109*/
...
static char *conf_blk_name[] = {
    ...
    [CONF_BLK_MLDSNP_CONF]              = "MLDSNP",
    [CONF_BLK_OS_FILE_CONF]             = "OS_FILE",
    [CONF_BLK_ICLI]                     = "ICLI",
    [CONF_BLK_VNS_FPGA_CONF]		= "VNS_FPGA_CONFIG",
