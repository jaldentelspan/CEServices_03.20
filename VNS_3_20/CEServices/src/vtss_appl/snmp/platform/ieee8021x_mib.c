...
#define DOT1XAUTHADMINCONTROLLEDDIRECTIONS      9
    {DOT1XAUTHADMINCONTROLLEDDIRECTIONS,  ASN_INTEGER,  RWRITE,  var_dot1xAuthConfigTable, 4,  {2, 1, 1, 3}},
...
#define DOT1XAUTHQUIETPERIOD        13
    {DOT1XAUTHQUIETPERIOD,  ASN_UNSIGNED,  RWRITE,  var_dot1xAuthConfigTable, 4,  {2, 1, 1, 7}},
...
#define DOT1XAUTHSERVERTIMEOUT      16
    {DOT1XAUTHSERVERTIMEOUT,  ASN_UNSIGNED,  RWRITE,  var_dot1xAuthConfigTable, 4,  {2, 1, 1, 10}},
...
#define DOT1XAUTHKEYTXENABLED       20
    {DOT1XAUTHKEYTXENABLED,  ASN_INTEGER,  RWRITE,  var_dot1xAuthConfigTable, 4,  {2, 1, 1, 14}},
