...
static lldp_u8_t location_subtype;
                              ...
                              u_char *statP, oid *name, size_t name_len)
{
    ...
    T_DG(TRACE_GRP_SNMP, "PORT_INDEX = %u, location_subtype  = %u", PORT_INDEX, location_subtype );
    switch (action) {
    case RESERVE1: {
        if (var_val_type != ASN_OCTET_STR) {
            (void) snmp_log(LOG_ERR,
