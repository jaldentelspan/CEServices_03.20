...
#if defined(VTSS_SW_OPTION_IP2)
// START - Moved from ip_stack_glue_api.h
...
// END - Moved from ip_stack_glue_api.h
#endif /* VTSS_SW_OPTION_IP2 */
...
#else
static BOOL ACCESS_MGMT_ip_stack_glue_callback(ip_stack_glue_frame_info_t *frame_info, const unsigned char *frame, const vtss_packet_rx_info_t *const rx_info)
#endif /* VTSS_SW_OPTION_IP2 */
{
...
#else
            ip_stack_glue_register(ACCESS_MGMT_ip_stack_glue_callback, ACCESS_MGMT_appl_type);
            ACCESS_MGMT_register_ip_stack_glue_flag = 1;
#endif /* VTSS_SW_OPTION_IP2 */
...
#else
            ip_stack_glue_unregister(ACCESS_MGMT_ip_stack_glue_callback);
#endif /* VTSS_SW_OPTION_IP2 */
