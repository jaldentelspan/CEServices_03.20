...
#define led_pow_reduc_custom_set_led_intensity(intensity) (void) vtss_phy_led_intensity_set(NULL, 13, intensity)
...
#define led_pow_reduc_custom_set_led_intensity(intensity) (void) vtss_fan_cool_lvl_set(NULL, intensity * 255 / 100)
...
#define led_pow_reduc_custom_api_init {\
                                         ...
                                         (void) vtss_fan_controller_init(NULL, &fan_spec ); \
                                      }
...
#define led_pow_reduc_custom_set_led_intensity(intensity) (void) vtss_phy_led_intensity_set(NULL, 0, intensity)
...
#define led_pow_reduc_custom_set_led_intensity(intensity) if (port_isid_info_board_type_get(VTSS_ISID_LOCAL) == VTSS_BOARD_JAG_CU48_REF) { \
                                                              (void) vtss_phy_led_intensity_set(NULL, 0, intensity); \
                                                              (void) vtss_phy_led_intensity_set(NULL, 12, intensity); \
                                                              (void) vtss_phy_led_intensity_set(NULL, 24, intensity);             \
                                                              (void) vtss_phy_led_intensity_set(NULL, 36, intensity); \
                                                          }
...
// **********************************************************************************************
// * Custom functions for VNS 6 reference board                                                 *
// **********************************************************************************************
#elif defined(BOARD_VNS_6_REF) || defined(BOARD_VNS_8_REF) || defined(BOARD_VNS_12_REF)  || defined(BOARD_VNS_16_REF) || defined(BOARD_NCGU_REF) || defined(BOARD_IGU_REF) || defined(BOARD_MITR_REF) || defined(BOARD_ESIR_REF) || defined(BOARD_VESM_REF)
...
/**
  ...
  * \param inst [IN]     LEDs intensity in percent.
  */
// For VNS, LEDS are controlled by the FPGA, and there is no fan.
#define led_pow_reduc_custom_set_led_intensity(intensity){}
...
/**
  ...
  *  The function MUST return a boolean (return TRUE if an error has happen else FALSE)
  */
#define led_pow_reduc_custom_on_at_error 0
