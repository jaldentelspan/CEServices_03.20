 ...
 * \return None.
 **/
void port_power_savings_common(i32 session_id, BOOL mode, BOOL urgent_queues, BOOL interface, BOOL actiphy, BOOL perfectreach, icli_stack_port_range_t *port_list, icli_range_t *urgent_queues_list, BOOL no, BOOL show_eee, BOOL show_actiphy, BOOL show_perfect_reach);
