                               ...
                               vtss_icfg_query_result_t *result)
{
  ...
  if (req->all_defaults ||
    ...
    if (fan_conf.glbl_conf.t_on == FAN_CONF_T_ON_DEFAULT) {
      VTSS_RC(vtss_icfg_printf(result, "no green-ethernet fan t_on\n"));
    } else {
      VTSS_RC(vtss_icfg_printf(result, "green-ethernet fan t_on %d\n", fan_conf.glbl_conf.t_on));
    }
  ...
  if (req->all_defaults ||
    ...
    if (fan_conf.glbl_conf.t_max == FAN_CONF_T_MAX_DEFAULT) {
      VTSS_RC(vtss_icfg_printf(result, "no green-ethernet fan t_max\n"));
    } else {
      VTSS_RC(vtss_icfg_printf(result, "green-ethernet fan t_max %d\n", fan_conf.glbl_conf.t_max));
    }
  }
  return VTSS_RC_OK;
}
...
{
  VTSS_RC(vtss_icfg_query_register(VTSS_ICFG_FAN_GLOBAL_CONF, fan_global_conf));
  return VTSS_RC_OK;
}
