...
#elif defined (BOARD_VNS_12_REF) || defined (BOARD_VNS_8_REF) || defined (BOARD_VNS_6_REF) || defined (BOARD_VNS_16_REF)
#include "vns_types.h"
#else
#endif
...
static cli_cmd_grp_t cli_cmd_grp_table[] = {
    ...
    {
        "Config",
        "Load/Save of configuration via TFTP"
    },
#endif
...
#endif /* VTSS_SW_OPTION_MITR_FPGA */ 
};
...
#ifdef VTSS_SW_OPTION_AUTH
    {
        VTSS_CLI_GRP_SEC_SWITCH_PATH "Auth",
        "Authentication"
    },
#endif
#ifdef VTSS_SW_OPTION_SSH
