...
vtss_rc ip_source_guard_icfg_init(void)
{
    ...
    */
    if ((rc = vtss_icfg_query_register(VTSS_ICFG_IP_SOURCE_GUARD_GLOBAL_CONF, IP_SOURCE_GUARD_ICFG_global_conf)) != VTSS_OK) {
        return rc;
    }

    rc = vtss_icfg_query_register(VTSS_ICFG_IP_SOURCE_GUARD_PORT_CONF, IP_SOURCE_GUARD_ICFG_port_conf);
