...
#ifdef NTP_ECOS
extern unsigned int ntp_sqrt P((int));
#else
...
extern	void 	ntp_process_packet	P((struct peer *, struct pkt *));
...
#ifdef NTP_ECOS
extern void reset_timer P((void));
#endif
...
#else
/* Avoid the same varialbe name "state" used in msg.c*/
extern int	ntp_state;	    /* clock discipline state */
#endif
