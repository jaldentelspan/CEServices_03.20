...
// TODO, delete this
//vtss_rc firmware_auto_update(ip_conf_t *conf, /* May be NULL - use defaults */
//                             const unsigned char *server, /* May be NULL - use default */
//                             const unsigned char *file); /* May be NULL - use default */
