...
vtss_rc dhcp_snooping_icfg_init(void)
{
    ...
    */
    if ((rc = vtss_icfg_query_register(VTSS_ICFG_DHCP_SNOOPING_GLOBAL_CONF, DHCP_SNOOPING_ICFG_global_conf)) != VTSS_OK) {
        return rc;
    }

    rc = vtss_icfg_query_register(VTSS_ICFG_DHCP_SNOOPING_PORT_CONF, DHCP_SNOOPING_ICFG_port_conf);
