...
#define SECS_TO_MS(sec) (sec*1000)
#define MIN_TO_MS(sec) (sec*60000)
#define SECS_TO_MINS(sec) (sec/60)
#define MS_TO_MIN(ms) (ms/60000)

/* WTR,Hold-Off and Guard Timeout max/min values */
#define  RAPS_WTR_TIMEOUT_MIN_MINITES        1 
#define  RAPS_WTR_TIMEOUT_MAX_MINITES        12
#define  RAPS_WTR_TIMEOUT_DEFAULT_MINITES    RAPS_WTR_TIMEOUT_MIN_MINITES
