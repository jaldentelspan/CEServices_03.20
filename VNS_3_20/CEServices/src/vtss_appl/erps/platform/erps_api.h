...
vtss_rc erps_mgmt_set_protection_group_request ( vtss_erps_mgmt_conf_t );

/* management function invoked from CLI/Web, inorder to edit protection 
 * group related parameters 
 */
vtss_rc erps_mgmt_getnext_protection_group_request (vtss_erps_mgmt_conf_t *);

/* function used to get a given protection group configaration 
