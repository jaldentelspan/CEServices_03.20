...
******************************************************************************
*/
#ifndef __ICLI_SESSION_H__
#define __ICLI_SESSION_H__
//****************************************************************************
...
typedef struct {
    ...
    //execution type
    icli_exec_type_t            exec_type;
    icli_after_cmd_act_t        after_cmd_act;
    ...
    icli_err_display_mode_t     err_display_mode;
    ...
    //parsing session
    i32                         b_in_parsing;
    icli_cmd_mode_t             current_parsing_mode;
    ...
    char                        *cmd_do;
#endif
    icli_port_type_t            last_port_type;
    ...
    ------------------------------------------------------------*/
    u32                         tab_cnt;
    icli_port_type_t            tab_port_type;

    /*------------------------------------------------------------
        History command
    ------------------------------------------------------------*/
    char                        history_cmd[ICLI_HISTORY_CMD_CNT][ICLI_STR_MAX_LEN + 4];
    i32                         history_head;
    i32                         history_tail;
    i32                         history_pos;
