...
*/
/*
    the size should be the same with icli_variable_type_t,
    otherwise, some issues will happen
    ICLI_VARIABLE_TYPE_MODIFY
*/
static const char       *g_variable_name[] = {
    "mac_addr",                 // ICLI_VARIABLE_MAC_ADDR,
    "mac_ucast",                // ICLI_VARIABLE_MAC_UCAST,
    "mac_mcast",                // ICLI_VARIABLE_MAC_MCAST,
    "ipv4_addr",                // ICLI_VARIABLE_IPV4_ADDR,
    "ipv4_netmask",             // ICLI_VARIABLE_IPV4_NETMASK,
    "ipv4_wildcard",            // ICLI_VARIABLE_IPV4_WILDCARD,
    "ipv4_ucast",               // ICLI_VARIABLE_IPV4_UCAST,
    "ipv4_mcast",               // ICLI_VARIABLE_IPV4_MCAST,
    "ipv4_subnet",              // ICLI_VARIABLE_IPV4_SUBNET,
    "ipv4_prefix",              // ICLI_VARIABLE_IPV4_PREFIX,
    "ipv6_addr",                // ICLI_VARIABLE_IPV6_ADDR,
    "ipv6_netmask",             // ICLI_VARIABLE_IPV6_NETMASK,
    "ipv6_ucast",               // ICLI_VARIABLE_IPV6_UCAST,
    "ipv6_mcast",               // ICLI_VARIABLE_IPV6_MCAST,
    "ipv6_subnet",              // ICLI_VARIABLE_IPV6_SUBNET,
    "ipv6_prefix",              // ICLI_VARIABLE_IPV6_PREFIX,
    "int8",                     // ICLI_VARIABLE_INT8,
    "int16",                    // ICLI_VARIABLE_INT16,
    "int",                      // ICLI_VARIABLE_INT,
    "uint8",                    // ICLI_VARIABLE_UINT8,
    "uint16",                   // ICLI_VARIABLE_UINT16,
    "uint",                     // ICLI_VARIABLE_UINT,
    "date",                     // ICLI_VARIABLE_DATE,
    "time",                     // ICLI_VARIABLE_TIME,
    "hhmm",                     // ICLI_VARIABLE_HHMM,
    "word",                     // ICLI_VARIABLE_WORD,
    "kword",                    // ICLI_VARIABLE_KWORD,
    "string",                   // ICLI_VARIABLE_STRING,
    "line",                     // ICLI_VARIABLE_LINE,
    "port_id",                  // ICLI_VARIABLE_PORT_ID,
    "port_list",                // ICLI_VARIABLE_PORT_LIST,
    "vlan_id",                  // ICLI_VARIABLE_VLAN_ID,
    "vlan_list",                // ICLI_VARIABLE_VLAN_LIST,
    "range_list",               // ICLI_VARIABLE_RANGE_LIST,
    "port_type",                // ICLI_VARIABLE_PORT_TYPE,
#if 1 /* CP, 2012/09/05 17:42, <port_type_id> */
    "port_type_id",             // ICLI_VARIABLE_PORT_TYPE_ID
#endif

#if 1 /* CP, 2012/09/07 11:52, <port_type_list> */
    "port_type_list",           // ICLI_VARIABLE_PORT_TYPE_LIST
#endif

#if 1 /* CP, 2012/09/24 16:13, <oui> */
    "oui",                      // ICLI_VARIABLE_OUI
#endif

#if 1 /* CP, 2012/09/25 10:47, <pcp> */
    "pcp",                      // ICLI_VARIABLE_PCP
#endif

#if 1 /* CP, 2012/09/25 10:47, <dscp> */
    "dscp",                     // ICLI_VARIABLE_DSCP
#endif

#if 1 /* CP, 2012/09/26 10:56, <dpl> */
    "dpl",                      // ICLI_VARIABLE_DPL
#endif

#if 1 /* CP, 2012/10/08 16:06, <hostname> */
    "hostname",                 // ICLI_VARIABLE_HOSTNAME
#endif

#if 1 /* CP, 2012/11/23 10:30, Bugzilla#10336 - <ipv4-nmcast> and <ipv6-nmcast> */
    "ipv4_nmcast",              // ICLI_VARIABLE_IPV4_NMCAST,
#endif

    //------ internal use       //------ internal use
    "grep",                     // ICLI_VARIABLE_GREP,
    "grep_begin",               // ICLI_VARIABLE_GREP_BEGIN,
    "grep_include",             // ICLI_VARIABLE_GREP_INCLUDE,
    "grep_exclude",             // ICLI_VARIABLE_GREP_EXCLUDE,
    "grep_string",              // ICLI_VARIABLE_GREP_STRING,
    "keyword",                  // ICLI_VARIABLE_KEYWORD,
    "int_range_id",             // ICLI_VARIABLE_INT_RANGE_ID,
    "uint_range_id",            // ICLI_VARIABLE_UINT_RANGE_ID,
    "int_range_list",           // ICLI_VARIABLE_INT_RANGE_LIST,
    "uint_range_list",          // ICLI_VARIABLE_UINT_RANGE_LIST,
    "range_word",               // ICLI_VARIABLE_RANGE_WORD,
    "range_kword",              // ICLI_VARIABLE_RANGE_KWORD,
    "range_string",             // ICLI_VARIABLE_RANGE_STRING,
    "range_line",               // ICLI_VARIABLE_RANGE_LINE,
};

static char *g_port_type_name[ICLI_PORT_TYPE_MAX] = {
    "None",                 // ICLI_PORT_TYPE_NONE
    "FastEthernet",         // ICLI_PORT_TYPE_FAST_ETHERNET
    "GigabitEthernet",      // ICLI_PORT_TYPE_GIGABIT_ETHERNET
    "2.5GigabitEthernet",   // ICLI_PORT_TYPE_2_5_GIGABIT_ETHERNET
    "5GigabitEthernet",     // ICLI_PORT_TYPE_FIVE_GIGABIT_ETHERNET
    "10GigabitEthernet",    // ICLI_PORT_TYPE_TEN_GIGABIT_ETHERNET
};

static char *g_port_type_help[ICLI_PORT_TYPE_MAX] = {
    "None",                         // ICLI_PORT_TYPE_NONE
    "Fast Ethernet Port",           // ICLI_PORT_TYPE_FAST_ETHERNET
    "1 Gigabit Ethernet Port",      // ICLI_PORT_TYPE_GIGABIT_ETHERNET
    "2.5 Gigabit Ethernet Port",    // ICLI_PORT_TYPE_2_5_GIGABIT_ETHERNET
    "5 Gigabit Ethernet Port",      // ICLI_PORT_TYPE_FIVE_GIGABIT_ETHERNET
    "10 Gigabit Ethernet Port",     // ICLI_PORT_TYPE_TEN_GIGABIT_ETHERNET
};

static u32                  g_min_vlan_id = ICLI_DEFAULT_MIN_VLAN_ID;
static u32                  g_max_vlan_id = ICLI_DEFAULT_MAX_VLAN_ID;
...
)
{
    ...
    //check ip
    ip_str = word;
    rc = _ipv4_ucast_get(ip_str, &ip, err_pos);
...
)
{
    ...
    //check ip
    ip_str = word;
    rc = _ipv6_ucast_get(ip_str, &ip, err_pos);
...
/*
    ...
    RETURN
        icli_rc_t
    COMMENT
        the length of val should be at least icli_str_len(word)+1, this check
...
)
{
    ...
    if ( icli_str_len(word) > ICLI_VALUE_STR_MAX_LEN ) {
        *err_pos = ICLI_VALUE_STR_MAX_LEN;
        return ICLI_RC_ERR_MATCH;
    }

    (void)icli_str_cpy(val, word);
    return ICLI_RC_OK;
}
...
)
{
    ...
    //do not copy ""
    (void)icli_str_ncpy(val, word + 1, len - 2);
    val[len - 2] = 0;
    return ICLI_RC_OK;
}
...
)
{
    ...
    (void)icli_str_ncpy(val, word, len);
    val[len] = 0;
...
)
{
    char                    *c = word,
                             *last_c,
                             number[ICLI_DIGIT_MAX_LEN + 1];
    u32                     pos;
    i32                     i,
                            n,
                            last_n,
                            cnt;
    icli_signed_range_t     *r;
    BOOL                    b_begin;
    ...
    /* get memory */
    r = (icli_signed_range_t *)icli_malloc( sizeof(icli_signed_range_t) );
    if ( r == NULL ) {
        T_E("memory insufficient\n");
        return ICLI_RC_ERR_MEMORY;
    }
    memset(r, 0, sizeof(icli_signed_range_t));
    ...
    for (;;) {
        ...
        if ( ICLI_IS_(EOS, *c) ) {
            if ( b_begin ) {
                r->range[cnt].max = last_n;
            }
            r->cnt = cnt + 1;
            memcpy( val, r, sizeof(icli_signed_range_t) );
            icli_free(r);
            return ICLI_RC_OK;
        }
...
)
{
    ...
    /* get memory */
    r = (icli_unsigned_range_t *)icli_malloc( sizeof(icli_unsigned_range_t) );
    if ( r == NULL ) {
        T_E("memory insufficient\n");
        return ICLI_RC_ERR_MEMORY;
    }
    memset(r, 0, sizeof(icli_unsigned_range_t));
    ...
    for (;;) {
        ...
        if ( ICLI_IS_(EOS, *c) ) {
            if ( b_begin ) {
                r->range[cnt].max = last_m;
            }
            r->cnt = cnt + 1;
            memcpy( val, r, sizeof(icli_unsigned_range_t) );
            icli_free(r);
            return ICLI_RC_OK;
        }
...
)
{
    ...
    /* get memory */
    switch_range = (icli_unsigned_range_t *)icli_malloc( sizeof(icli_unsigned_range_t) );
    if ( switch_range == NULL ) {
        T_E("memory insufficient\n");
        return ICLI_RC_ERR_MEMORY;
    }
    memset(switch_range, 0, sizeof(icli_unsigned_range_t));

    /* get memory */
    port_range = (icli_unsigned_range_t *)icli_malloc( sizeof(icli_unsigned_range_t) );
    if ( port_range == NULL ) {
        T_E("memory insufficient\n");
        icli_free(switch_range);
        return ICLI_RC_ERR_MEMORY;
    }
    memset(port_range, 0, sizeof(icli_unsigned_range_t));

    /* get stack_range */
    stack_range = (icli_stack_port_range_t *)icli_malloc( sizeof(icli_stack_port_range_t) );
    if ( stack_range == NULL ) {
        T_E("memory insufficient\n");
        icli_free(switch_range);
        icli_free(port_range);
        return ICLI_RC_ERR_MEMORY;
    }
    /* reset port_range */
    memset( stack_range, 0, sizeof(icli_stack_port_range_t) );
...
{
    return _uint_get_in_range(word, g_min_vlan_id, g_max_vlan_id, val, err_pos);
}
...
)
{
    ...
    /* get memory */
    sr = (icli_signed_range_t *)icli_malloc( sizeof(icli_signed_range_t) );
    if ( sr == NULL ) {
        T_E("memory insufficient\n");
        return ICLI_RC_ERR_MEMORY;
    }
    ...
    /* get memory */
    ur = (icli_unsigned_range_t *)icli_malloc( sizeof(icli_unsigned_range_t) );
    if ( ur == NULL ) {
        T_E("memory insufficient\n");
        icli_free(sr);
        return ICLI_RC_ERR_MEMORY;
...
/*
    ...
    COMMENT
        n/a
*/
static i32 _int_range_list_get(
    IN  char                    *word,
    IN  icli_range_t            *range,
    OUT icli_signed_range_t     *val,
    OUT u32                     *err_pos
...
/*
    ...
    COMMENT
        n/a
*/
static i32 _uint_range_list_get(
    IN  char                    *word,
    IN  icli_range_t            *range,
    OUT icli_unsigned_range_t   *val,
    OUT u32                     *err_pos
...
#define __PORT_TYPE_CHECK_AND_ASSIGN(t, x) \
    if ( icli_str_sub(word, g_port_type_name[t], FALSE, &(x)) >= 0 ) { \
        *val = t; \
        return ICLI_RC_OK; \
    }
...
{
    if ( icli_str_sub(word, ICLI_GREP_KEYWORD, 0, err_pos) == -1 ) {
        return ICLI_RC_ERR_MATCH;
    }
...
{
    if ( icli_str_sub(word, ICLI_GREP_BEGIN_KEYWORD, 0, err_pos) == -1 ) {
        return ICLI_RC_ERR_MATCH;
    }
...
{
    if ( icli_str_sub(word, ICLI_GREP_INCLUDE_KEYWORD, 0, err_pos) == -1 ) {
        return ICLI_RC_ERR_MATCH;
    }
...
{
    if ( icli_str_sub(word, ICLI_GREP_EXCLUDE_KEYWORD, 0, err_pos) == -1 ) {
        return ICLI_RC_ERR_MATCH;
    }
...
)
{
    ...
    //check " at the tail
    if ( ICLI_NOT_(STRING_END, *(c - 1)) || ICLI_IS_(BACK_SLASH, *(c - 2))) {
        return ICLI_RC_ERR_INCOMPLETE;
    }
...
/*
    ...
    COMMENT
        the length of val should be at least icli_str_len(word)+1,
...
#define _WORD_VARIABLE_RANGE_GET(type, range_type) \
    r = icli_str_sub(g_variable_name[type], name, 1, NULL); \
    if ( r == 1 ) { \
        t = range_type; \
        c = name + icli_str_len( g_variable_name[type] ); \
        break; \
    }
...
)
{
    ...
    do {
        _WORD_VARIABLE_RANGE_GET( ICLI_VARIABLE_WORD, ICLI_VARIABLE_RANGE_WORD );

        _WORD_VARIABLE_RANGE_GET( ICLI_VARIABLE_KWORD, ICLI_VARIABLE_RANGE_KWORD );

        _WORD_VARIABLE_RANGE_GET( ICLI_VARIABLE_STRING, ICLI_VARIABLE_RANGE_STRING );

        _WORD_VARIABLE_RANGE_GET( ICLI_VARIABLE_LINE, ICLI_VARIABLE_RANGE_LINE );
    ...
    /* get memory */
    rge = (icli_range_t *)icli_malloc( sizeof(icli_range_t) );
    if ( rge == NULL ) {
        T_E("memory insufficient\n");
        return ICLI_RC_ERR_MEMORY;
    }
    memset(rge, 0, sizeof(icli_range_t));

    rge->type = ICLI_RANGE_TYPE_UNSIGNED;
    rge->u.ur.cnt = 1;
    rge->u.ur.range[0].min = 1;
    rge->u.ur.range[0].max = ICLI_VALUE_STR_MAX_LEN;

    r = _range_list_get_with_delimiter( c, ICLI_DASH, rge, range, NULL );
    if ( r == ICLI_RC_OK ) {
        *type = t;
    }
    icli_free(rge);
...
*/
/*
    get variable name for the type
    ...
    RETURN
        not NULL    variable name if successful
        NULL        if invalid

    COMMENT
        n/a
*/
const char *icli_variable_name_get(
    IN  icli_variable_type_t    type
)
{
    if (type >= ICLI_VARIABLE_KEYWORD) {
        return NULL;
    }
    return g_variable_name[type];
}
...
)
{
    ...
    for ( i = 0; i < ICLI_VARIABLE_KEYWORD; i++ ) {
        if ( icli_str_cmp(name, g_variable_name[i]) == 0 ) {
...
#define CASE_MAC(x,y,n) \
    case ICLI_VARIABLE_MAC_##x :\
        rc = _mac_##y##_get_##n(word, &(value->u.u_mac_##y), err_pos);\
        break
...
#define CASE_RANGE_ID(x,y) \
    case ICLI_VARIABLE_##x##_RANGE_ID:\
        rc = _##y##_range_id_get(word, range, &(value->u.u_##y), err_pos);\
        break
...
/*
    ...
    INPUT
        type  : variable type
        word  : user input word
        range : used for type == ICLI_VARIABLE_INT_RANGE_ID
...
#if (ICLI_VARIABLE_STYLE == 0)
        CASE_MAC( ADDR,  addr,  0 );
        CASE_MAC( UCAST, ucast, 0 );
        CASE_MAC( MCAST, mcast, 0 );
#elif (ICLI_VARIABLE_STYLE == 1)
        CASE_MAC( ADDR,  addr,  1 );
        CASE_MAC( UCAST, ucast, 1 );
        CASE_MAC( MCAST, mcast, 1 );
#endif

        CASE_VARIABLE( IPV4_ADDR,     ipv4_addr );
        CASE_VARIABLE( IPV4_NETMASK,  ipv4_netmask );
        CASE_VARIABLE( IPV4_WILDCARD, ipv4_wildcard );
        CASE_VARIABLE( IPV4_UCAST,    ipv4_ucast );
        CASE_VARIABLE( IPV4_MCAST,    ipv4_mcast );
        CASE_VARIABLE( IPV4_SUBNET,   ipv4_subnet );
        CASE_VARIABLE( IPV4_PREFIX,   ipv4_prefix );

        CASE_VARIABLE( IPV6_ADDR,    ipv6_addr );
        CASE_VARIABLE( IPV6_NETMASK, ipv6_netmask );
        CASE_VARIABLE( IPV6_UCAST,   ipv6_ucast );
        CASE_VARIABLE( IPV6_MCAST,   ipv6_mcast );
        CASE_VARIABLE( IPV6_SUBNET,  ipv6_subnet );
        CASE_VARIABLE( IPV6_PREFIX,  ipv6_prefix );

        CASE_VARIABLE( INT8,        int8 );
        CASE_VARIABLE( INT16,       int16 );
        CASE_VARIABLE( INT,         int );
        CASE_VARIABLE( UINT8,       uint8 );
        CASE_VARIABLE( UINT16,      uint16 );
        CASE_VARIABLE( UINT,        uint );

        CASE_VARIABLE( PORT_ID,     port_id );
        CASE_VARIABLE( PORT_LIST,   port_list );
        CASE_VARIABLE( PORT_TYPE,   port_type );

#if 1 /* CP, 2012/09/05 17:42, <port_type_id> */
        CASE_VARIABLE( PORT_TYPE_ID, port_type_id );
#endif

#if 1 /* CP, 2012/09/07 11:52, <port_type_list> */
        CASE_VARIABLE( PORT_TYPE_LIST, port_type_list );
#endif

        CASE_VARIABLE( VLAN_ID,     vlan_id );
        CASE_VARIABLE( VLAN_LIST,   vlan_list );

        CASE_RANGE_ID( INT,         int );
        CASE_RANGE_ID( UINT,        uint );

        CASE_VARIABLE_RANGE( RANGE_LIST,      range_list );
        CASE_VARIABLE_RANGE( INT_RANGE_LIST,  int_range_list );
        CASE_VARIABLE_RANGE( UINT_RANGE_LIST, uint_range_list );

        CASE_VARIABLE( DATE, date );
        CASE_VARIABLE( TIME, time );
        CASE_VARIABLE( HHMM, hhmm );

        CASE_VARIABLE_P( WORD,        word );
        CASE_VARIABLE_P( KWORD,       kword );
        CASE_VARIABLE_P( STRING,      string );
        CASE_VARIABLE_P( LINE,        line );
        CASE_VARIABLE_P( GREP_STRING, line );

        CASE_VARIABLE( GREP,         grep );
        CASE_VARIABLE( GREP_BEGIN,   grep_begin );
        CASE_VARIABLE( GREP_INCLUDE, grep_include );
        CASE_VARIABLE( GREP_EXCLUDE, grep_exclude );

        CASE_VARIABLE_RANGE_P( RANGE_WORD,   range_word );
        CASE_VARIABLE_RANGE_P( RANGE_KWORD,  range_kword );
        CASE_VARIABLE_RANGE_P( RANGE_STRING, range_string );
        CASE_VARIABLE_RANGE_P( RANGE_LINE,   range_line );

#if 1 /* CP, 2012/09/24 16:13, <oui> */
        CASE_VARIABLE( OUI,   oui );
#endif

#if 1 /* CP, 2012/09/25 10:47, <pcp> */
        CASE_VARIABLE( PCP,   pcp );
#endif

#if 1 /* CP, 2012/09/26 10:56, <dpl> */
        CASE_VARIABLE( DPL,   dpl );
#endif

#if 1 /* CP, 2012/10/08 16:06, <hostname> */
        CASE_VARIABLE_P( HOSTNAME, hostname );
#endif

#if 1 /* CP, 2012/11/23 10:30, Bugzilla#10336 - <ipv4-nmcast> */
        CASE_VARIABLE( IPV4_NMCAST, ipv4_nmcast );
#endif
...
/*
    get the range of VLAN ID

    INPUT
        min_vlan_id : minimum VLAN id
        max_vlan_id : maximum VLAN id
    ...
    COMMENT
        n/a
*/
i32 icli_variable_vlan_range_set(
    IN  u32     min_vlan_id,
    IN  u32     max_vlan_id
)
{
    ...
    g_min_vlan_id = min_vlan_id;
    g_max_vlan_id = max_vlan_id;
    return ICLI_RC_OK;
}
...
/*
    ...
    COMMENT
        n/a
*/
char *icli_variable_port_type_get_name(
    IN  icli_port_type_t    type
)
{
    if ( type < ICLI_PORT_TYPE_MAX ) {
        return g_port_type_name[type];
    } else {
        return "Unknown";
    }
}
...
/*
    ...
    COMMENT
        n/a
*/
char *icli_variable_port_type_get_help(
    IN  icli_port_type_t    type
)
{
    if ( type < ICLI_PORT_TYPE_MAX ) {
        return g_port_type_help[type];
    } else {
        return "Unknown";
    }
}
...
/*
    ...
    COMMENT
        n/a
*/
icli_dscp_wvh_t *icli_variable_dscp_wvh_get(
    void
)
{
    return g_dscp_wvh;
...
/*
    ...
    RETURN
        ...
        FALSE - fail to get
*/
BOOL icli_variable_decimal_get(
    IN  char    *word,
    OUT u32     *val
)
{
