...
)
{
    ...
    /* check length */
    if (icli_str_len(sub) > icli_str_len(s)) {
        return NULL;
    }
    len = icli_str_len(s) - icli_str_len(sub) + 1;
