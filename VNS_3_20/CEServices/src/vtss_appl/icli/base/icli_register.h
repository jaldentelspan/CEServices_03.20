...
******************************************************************************
*/
#ifndef __ICLI_REGISTER_H__
#define __ICLI_REGISTER_H__
//****************************************************************************
...
/*
    ...
    COMMENT
        n/a
*/
i32 icli_register_cmd_is_enable(
    IN  u32     cmd_id,
    OUT BOOL    *enable
);
...
/*
    ...
    COMMENT
        n/a
*/
i32 icli_register_cmd_is_visible(
    IN  u32     cmd_id,
    OUT BOOL    *visible
);
...
/*
    ...
    COMMENT
        n/a
*/
i32 icli_register_cmd_invisible(
    IN  u32     cmd_id
);
...
/*
    ...
    COMMENT
        n/a
*/
i32 icli_register_cmd_privilege_get(
    IN  u32     cmd_id,
    OUT u32     *privilege
);
...
/*
    ...
    COMMENT
        n/a
*/
i32 icli_register_cmd_privilege_set(
    IN u32     cmd_id,
    IN u32     privilege
);
...
/*
    ...
    COMMENT
        n/a
*/
char *icli_register_cmd_str_get(
    IN  u32     cmd_id
);

//****************************************************************************
#endif //__ICLI_REGISTER_H__
