...
#define IPMC_LIB_ICFG_REG(x, y, z)  (((x) = vtss_icfg_query_register((y), (z))) == VTSS_OK)
...
vtss_rc ipmc_lib_icfg_init(void)
{
    ...
    if (IPMC_LIB_ICFG_REG(rc, VTSS_ICFG_IPMC_LIB_IPMC_RANGE, _ipmc_lib_icfg_profile_entry)) {
        if (IPMC_LIB_ICFG_REG(rc, VTSS_ICFG_IPMC_LIB_PROFILE_DESC_RANGE, _ipmc_lib_icfg_profile_table)) {
            if (IPMC_LIB_ICFG_REG(rc, VTSS_ICFG_IPMC_LIB_IPMC_PROFILE_CTRL, _ipmc_lib_icfg_profile_state)) {
