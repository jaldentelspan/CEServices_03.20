                                        ...
                                        const vtss_pcs_10gbase_r_event_t    ev_mask)
{
    ...
    if ((rc = vtss_inst_port_no_check(inst, port_no)) == VTSS_RC_OK ) {
        rc = VTSS_FUNC_COLD(pcs_10gbase_r_event_enable, port_no, enable, ev_mask);
    }
    VTSS_EXIT();
    return rc;
}
                                      ...
                                      vtss_pcs_10gbase_r_event_t   *const status)
{
    ...
    VTSS_ENTER();
    if ((rc = vtss_inst_port_no_check(inst, port_no)) == VTSS_RC_OK ) {
        rc = VTSS_FUNC_COLD(pcs_10gbase_r_event_poll, port_no, status);
    }
    VTSS_EXIT();
    return rc;
}
                                                   ...
                                                   vtss_pcs_10gbase_r_event_t   *const status)
{
    ...
    VTSS_ENTER();
    if ((rc = vtss_inst_port_no_check(inst, port_no)) == VTSS_RC_OK) {
        rc = VTSS_FUNC_COLD(pcs_10gbase_r_event_poll_without_mask, port_no, status);
    }
    VTSS_EXIT();
    return rc;
}
                                      ...
                                      const vtss_pcs_10gbase_r_cfg_t *const cfg)
{
    ...
    if ((rc = vtss_inst_port_no_check(inst, port_no)) == VTSS_RC_OK && cfg) {
        ...
        rc = VTSS_FUNC_COLD(pcs_10gbase_r_config_set, port_no);
    }
    VTSS_EXIT();
    return rc;
}
                                      ...
                                      vtss_pcs_10gbase_r_status_t * const status)
{
    ...
    if ((rc = vtss_inst_port_no_check(inst, port_no)) == VTSS_RC_OK && status) {
        rc = VTSS_FUNC_COLD(pcs_10gbase_r_status_get, port_no, status);
    }
    VTSS_EXIT();
    return rc;
}
                                           ...
                                           const vtss_port_no_t port_no)
{
    ...
    VTSS_ENTER();
    if ((rc = vtss_inst_port_no_check(inst, port_no)) == VTSS_RC_OK) {
        rc = VTSS_FUNC_COLD(pcs_10gbase_r_counters_update, port_no);
    }
    VTSS_EXIT();
    return rc;
}
                                          ...
                                          const vtss_port_no_t port_no)
{
    ...
    VTSS_ENTER();
    if ((rc = vtss_inst_port_no_check(inst, port_no)) == VTSS_RC_OK) {
        rc = VTSS_FUNC_COLD(pcs_10gbase_r_counters_clear, port_no);
    }
    VTSS_EXIT();
    return rc;
}
                                        ...
                                        vtss_pcs_10gbase_r_cnt_t * const counters)
{
    ...
    VTSS_D("port_no: %u", port_no);
    VTSS_ENTER();
    if ((rc = vtss_inst_port_no_check(inst, port_no)) == VTSS_RC_OK && counters) {
        rc = VTSS_FUNC_COLD(pcs_10gbase_r_counters_get, port_no, counters);
    }
    VTSS_EXIT();
    return rc;
}
