...
vtss_rc vtss_phy_init_seq_atom(vtss_phy_port_state_t *ps,
                               vtss_port_no_t        port_no,
                               BOOL                  luton26_mode);

vtss_rc vtss_phy_pre_reset_private(const vtss_port_no_t port_no);
vtss_rc vtss_phy_wait_for_micro_complete(vtss_port_no_t port_no);

vtss_rc vtss_phy_is_8051_crc_ok_private (vtss_port_no_t port_no,
                                         u16 start_addr,
                                         u16 code_length,
                                         u16 expected_crc);
...
vtss_rc vtss_phy_init_seq_blazer(vtss_phy_port_state_t *ps,
                                 vtss_port_no_t        port_no);
