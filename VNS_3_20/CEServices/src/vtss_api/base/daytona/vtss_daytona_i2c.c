 ...
 * \return Return code.
 **/
static vtss_rc vtss_daytona_i2c_config_set(const vtss_i2c_controller_t *const controller_cfg,
 ...
 * \return Return code.
 **/
static vtss_rc vtss_daytona_i2c_config_get(const vtss_i2c_controller_t *const controller_cfg,
 ...
 * \return Return code.
 **/
static vtss_rc vtss_daytona_i2c_status_get(const vtss_i2c_controller_t *const controller_cfg,
                                                 u16                   *const status)
{
    vtss_rc rc = VTSS_RC_OK;
    u32     reg_val_rx = 0;
 ...
 * \return Return code.
 **/
static vtss_rc vtss_daytona_i2c_rx(const vtss_i2c_controller_t *const controller_cfg,
                                         u8                    *const data)
{
 ...
 * \return Return code.
 **/
static vtss_rc vtss_daytona_i2c_tx(const vtss_i2c_controller_t *const controller_cfg,
 ...
 * \return Return code.
 **/
static vtss_rc vtss_daytona_i2c_cmd(const vtss_i2c_controller_t *const controller_cfg,
                                    const u16                          cmd_flags)
{
    vtss_rc rc = VTSS_RC_OK;
    u32     tmp_cmd_flags = 0;
 ...
 * \return Return code.
 **/
static vtss_rc vtss_daytona_i2c_stop(const vtss_i2c_controller_t *const controller_cfg)
{
    vtss_rc rc = VTSS_RC_OK;
    u32     reg_val_tx = 0;
    u32     reg_mask_tx = 0;
 ...
 * \return Return code.
 **/
vtss_rc vtss_daytona_inst_i2c_create(void)
{
