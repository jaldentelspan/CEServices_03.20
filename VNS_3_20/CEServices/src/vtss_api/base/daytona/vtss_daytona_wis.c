...
static vtss_rc daytona_ewis_mode_set(const vtss_port_no_t port_no)
{
    u32 target;
    ...
    VTSS_RC(daytona_port_2_target(port_no, DAYTONA_BLOCK_EWIS, &target));
    do {
        ...
        VTSS_RC(vtss_daytona_blk_oper_mode_get(port_no, channel, (side ? BLOCK_WIS_2 : BLOCK_WIS_1), &blk_mode));
 ...
 **/
static vtss_rc daytona_ewis_cons_action_set(const vtss_port_no_t port_no)
{
    u32 target;
    u32 reg, mask;
...
static vtss_rc daytona_ewis_section_txti_set(const vtss_port_no_t port_no)
{
    u32 target;
...
static vtss_rc daytona_ewis_force_conf_set(const vtss_port_no_t port_no)
{
    u32 target;
...
static vtss_rc daytona_ewis_tx_oh_set(const vtss_port_no_t port_no)
{
    u32 target;
...
static vtss_rc daytona_ewis_tx_oh_passthru_set(const vtss_port_no_t port_no)
{
    u32 target;
...
static vtss_rc daytona_ewis_exp_sl_set(const vtss_port_no_t port_no)
{
    u32 target;
 ...
 * \return Return code.
 **/
static vtss_rc daytona_ewis_path_txti_set(const vtss_port_no_t port_no)
{
    u32 target;
    vtss_ewis_tti_t txti;
    uint tti_size;
 ...
 * \return Return code.
 **/
static vtss_rc daytona_ewis_counter_get(const vtss_port_no_t port_no,
 ...
 * 
 **/
static vtss_rc daytona_ewis_test_mode_set(const vtss_port_no_t port_no)
{
 ...
 **/
static vtss_rc daytona_ewis_prbs31_err_inj_set (vtss_port_no_t port_no,
 ...
 * Daytona registers: Not supported (as it is only relevant for prbs31.
 **/
static vtss_rc daytona_ewis_test_counter_get(const vtss_port_no_t port_no, vtss_ewis_test_status_t *const test_status)
{
    /* TBD :: Postpone for Later releases */
    return VTSS_RC_ERROR;
}
 ...
 *
 **/
static vtss_rc daytona_ewis_status_get(const vtss_port_no_t port_no,
 ...
 **/
static vtss_rc daytona_ewis_defects_get(const               vtss_port_no_t port_no,
 ...
 *
 **/
static vtss_rc daytona_ewis_section_acti_get(const vtss_port_no_t port_no,
 ...
 *
 **/
static vtss_rc daytona_ewis_path_acti_get(const vtss_port_no_t port_no,
                                vtss_ewis_tti_t *const acti)
{
    u32 target;
    u32 value;
 ...
 *
 **/
static vtss_rc daytona_ewis_perf_get(const vtss_port_no_t port_no,
...
static vtss_rc daytona_ewis_perf_mode_set(const vtss_port_no_t port_no)
{
    u32 target;
 ...
 *  Defects/Events
 * ================================================================= */
static vtss_rc daytona_ewis_event_enable(const vtss_port_no_t      port_no,
                                         const BOOL                enable,
...
static vtss_rc daytona_ewis_event_poll(const vtss_port_no_t  port_no,
...
static vtss_rc daytona_ewis_event_poll_without_mask(const vtss_port_no_t  port_no,
                                       vtss_ewis_event_t     *const status)
{
    u32 target;
    u32 sticky;
 ...
 * ================================================================= */
vtss_rc vtss_daytona_wis_restart_conf_set(void)
{
    vtss_port_no_t port_no;
    vtss_rc rc = VTSS_RC_OK;

    for (port_no = 0 ; port_no < vtss_state->port_count; port_no++) {
        VTSS_RC(daytona_ewis_cons_action_set(port_no));
        VTSS_RC(daytona_ewis_section_txti_set(port_no));
        VTSS_RC(daytona_ewis_path_txti_set(port_no));
        //VTSS_RC(daytona_ewis_test_mode_set(port_no));/* TBD :: Postpone for Later releases */
        VTSS_RC(daytona_ewis_tx_oh_set(port_no));
        VTSS_RC(daytona_ewis_tx_oh_passthru_set(port_no));
        VTSS_RC(daytona_ewis_exp_sl_set(port_no));
 ...
 * \return Return code.
 **/
vtss_rc vtss_daytona_inst_wis_create(void)
{
    vtss_port_no_t port_no;
