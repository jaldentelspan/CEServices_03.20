...
static u32 auto_odu_ais(const vtss_port_no_t port_no)
{
    u32 i;
...
static vtss_rc  odu_aps_config(const vtss_port_no_t port_no, u32 target)
{
    u32 value, i=0;
 ...
 *  OCH Config
 * ================================================================= */
static vtss_rc daytona_otn_och_fec_set(const vtss_port_no_t port_no, const vtss_otn_och_fec_t   *const cfg)
{
    ...
    VTSS_RC(daytona_port_2_target(port_no, DAYTONA_BLOCK_OTN_WRAPPER, &otn_target));
    VTSS_RC(daytona_port_2_target(port_no, DAYTONA_BLOCK_EFECI4, &efec4_target));
    VTSS_RC(daytona_port_2_target(port_no, DAYTONA_BLOCK_EFECI7, &efec7_target)); 
    VTSS_RC(daytona_port_2_channel_side(port_no, &channel, &side));
    ...
    switch (cfg->type) {
        ...
        case VTSS_OTN_OCH_FEC_I7:
            if(side == 1) {
                ...
                DAYTONA_WRM(VTSS_OTN_WRAPPER_XCO2_RX_OTN_XCO2_RX_OTN_GLOBAL_CONTROL(otn_target), VTSS_F_OTN_WRAPPER_XCO2_RX_OTN_XCO2_RX_OTN_GLOBAL_CONTROL_FEC_ENABLE(0), VTSS_M_OTN_WRAPPER_XCO2_RX_OTN_XCO2_RX_OTN_GLOBAL_CONTROL_FEC_ENABLE);
...
static vtss_rc daytona_otn_och_loopback_set(const vtss_port_no_t port_no)
{
    u32 target;

    VTSS_RC(daytona_port_2_target(port_no, DAYTONA_BLOCK_OTN_WRAPPER, &target));
 ...
 *  OTU Config
 * ================================================================= */
static vtss_rc daytona_otn_otu_tti_set(const vtss_port_no_t port_no)
{
    u32 target;
    u8  i;
    u16 temp_tti = 0;
...
static vtss_rc daytona_otn_otu_acc_tti_get(const vtss_port_no_t port_no,vtss_otn_otu_acc_tti_t *const tti)
{
...
static vtss_rc daytona_otn_otu_ais_set(const vtss_port_no_t port_no)
{
    u32 target;
...
static vtss_rc daytona_otn_otu_consequent_actions_set(const vtss_port_no_t port_no)
{
    u32 target;
    ...
    DAYTONA_WRM(VTSS_OTN_WRAPPER_XCO2_RX_OTN_XCO2_RX_OTN_ODU_MAINTENANCE_CONTROL(target), VTSS_F_OTN_WRAPPER_XCO2_RX_OTN_XCO2_RX_OTN_ODU_MAINTENANCE_CONTROL_AUTO_ODU_AIS(auto_odu_ais(port_no)), VTSS_M_OTN_WRAPPER_XCO2_RX_OTN_XCO2_RX_OTN_ODU_MAINTENANCE_CONTROL_AUTO_ODU_AIS);
...
static vtss_rc daytona_otn_otu_oh_insertion_set(const vtss_port_no_t port_no)
{
    u32                target;
...
static vtss_rc daytona_otn_otu_tx_res_set(const vtss_port_no_t port_no)
{
    u32 target;
...
static vtss_rc daytona_otn_otu_acc_res_get(const vtss_port_no_t port_no, vtss_otn_otu_acc_res_t   *const res)
{
    u32 target;
    u32 value = 0, status;
...
static vtss_rc daytona_otn_otu_tx_smres_set(const vtss_port_no_t port_no)
{
    u32 target;
...
static vtss_rc daytona_otn_otu_acc_smres_get(const vtss_port_no_t port_no, vtss_otn_otu_acc_smres_t   *const smres)
{
    u32 target;
    u32 value = 0, status;
...
static vtss_rc daytona_otn_otu_tx_gcc0_set(const vtss_port_no_t port_no)
{
    u32 target;
...
static vtss_rc daytona_otn_otu_acc_gcc0_get(const vtss_port_no_t port_no, vtss_otn_otu_acc_gcc0_t   *const gcc0)
{
    u32 target;
    u32 value = 0, status;
 ...
 *  ODU Config
 * ================================================================= */
static vtss_rc daytona_otn_odu_mode_set(const vtss_port_no_t port_no)
{
    u32 target;
...
static vtss_rc daytona_otn_odu_tti_set(const vtss_port_no_t port_no)
{
    u32 target;
    u8  i;
    u16 temp_tti = 0;
...
static vtss_rc daytona_otn_odu_ais_set(const vtss_port_no_t port_no)
{
    u32 target;
...
static vtss_rc daytona_otn_odu_consequent_actions_set(const vtss_port_no_t port_no)
{
    u32 target;
...
static vtss_rc daytona_otn_odu_oh_insertion_set(const vtss_port_no_t port_no)
{
    u32                target;
    vtss_rc            rc = VTSS_RC_OK;
    daytona_channel_t  channel;
...
static vtss_rc daytona_otn_odu_tx_res_set(const vtss_port_no_t port_no)
{
    u32 target;
    u8 res_low = 0;
    u16 res_high = 0;
...
static vtss_rc daytona_otn_odu_tx_exp_set(const vtss_port_no_t port_no)
{
    u32 target;
    u16 exp_value = 0;
    VTSS_RC(daytona_port_2_target(port_no, DAYTONA_BLOCK_OTN_WRAPPER, &target));
...
static vtss_rc daytona_otn_odu_tx_ftfl_set(const vtss_port_no_t port_no)
{
    u32 target;
    u8 i = 0;
    u16 temp_ftfl = 0;
...
static vtss_rc daytona_otn_odu_tx_aps_set(const vtss_port_no_t port_no)
{
    u32 target;

    VTSS_RC(daytona_port_2_target(port_no, DAYTONA_BLOCK_OTN_WRAPPER, &target));

    return(odu_aps_config(port_no, target));
}

static vtss_rc daytona_otn_odu_pt_set(const vtss_port_no_t port_no)
{
    u32 target;
...
static vtss_rc daytona_otn_odu_opu_oh_insertion_set(const vtss_port_no_t port_no)
{
    u32                target;
    vtss_rc            rc = VTSS_RC_OK;
    daytona_channel_t  channel;
...
static vtss_rc daytona_otn_odu_opu_test_insertion_set(const vtss_port_no_t port_no)
{
    u32     target;
    vtss_rc rc = VTSS_RC_OK;
...
static vtss_rc daytona_otn_odu_acc_tti_get(const vtss_port_no_t port_no, vtss_otn_odu_acc_tti_t *const tti)
{
    u32 target, value, status;
    u8  i;
    u16 temp_tti1 = 0,temp_tti2 = 0;
...
static vtss_rc daytona_otn_odu_acc_res_get(const vtss_port_no_t port_no, vtss_otn_odu_acc_res_t *const res)
{
...
static vtss_rc daytona_otn_odu_acc_exp_get(const vtss_port_no_t port_no, vtss_otn_odu_acc_exp_t *const exp)
{
...
static vtss_rc daytona_otn_odu_acc_ftfl_get(const vtss_port_no_t port_no, vtss_otn_odu_acc_ftfl_t *const ftfl)
{
...
static vtss_rc daytona_otn_odu_acc_aps_get(const vtss_port_no_t port_no, vtss_otn_odu_acc_aps_t *const aps)
{
    u32 target, value;
...
static vtss_rc daytona_otn_odu_acc_pt_get(const vtss_port_no_t port_no, vtss_otn_odu_acc_pt_t *const pt)
{
    u32 target, value, status;
 ...
 *  ODUT Config
 * ================================================================= */
static vtss_rc daytona_otn_odut_mode_set(const vtss_port_no_t port_no, const u32 level)
{
    u32 target;
...
static vtss_rc daytona_otn_odut_tti_set(const vtss_port_no_t port_no, const u32 level)
{
    u32 target;
    u8  i;
    u16 temp_tti = 0;
...
static vtss_rc daytona_otn_odut_consequent_actions_set(const vtss_port_no_t port_no, const u32 level)
{
    u32 target, value, i;
...
static vtss_rc daytona_otn_odut_bdi_set(const vtss_port_no_t port_no, const u32 level)
{
    u32 target, value;
...
static vtss_rc daytona_otn_odut_tx_stat_set(const vtss_port_no_t port_no, const u32 level)
{
    u32 target, value;
...
static vtss_rc daytona_otn_odut_tx_aps_set(const vtss_port_no_t port_no, const u32 level)
{
    u32 target;
...
static vtss_rc daytona_otn_odut_acc_tti_get(const vtss_port_no_t port_no, const u32 level, vtss_otn_odut_acc_tti_t *const tti)
{
    u32 target, value, status;
    u8  i;
    u16 temp_tti1 = 0,temp_tti2 = 0;
...
static vtss_rc daytona_otn_odut_acc_stat_get(const vtss_port_no_t port_no, const u32 level, vtss_otn_odut_acc_stat_t *const stat)
{
    u32 target, value;
...
static vtss_rc daytona_otn_odut_acc_aps_get(const vtss_port_no_t port_no, const u32 level, vtss_otn_odut_acc_aps_t *const aps)
{
    u32 target, value;
 ...
 *  State Reporting
 * ================================================================= */
static vtss_rc daytona_otn_och_defects_get(const vtss_port_no_t port_no, vtss_otn_och_defects_t *const defects)
{
    u32 target;
    u32 status;
...
static vtss_rc daytona_otn_otu_defects_get(const vtss_port_no_t port_no, vtss_otn_otu_defects_t *const defects)
{
    u32 target;
    u32 status;
...
static vtss_rc daytona_otn_odu_defects_get(const vtss_port_no_t port_no, vtss_otn_odu_defects_t *const defects)
{
    u32 target;
    u32 status;
    ...
    defects->dais = (status & VTSS_M_OTN_WRAPPER_WRAPPER_GROUP_RX_OTN_ODU_PM_INTERRUPT_STATUS_PM_AIS_IRQ);
...
static vtss_rc daytona_otn_odut_defects_get(const vtss_port_no_t port_no, const u32 level, vtss_otn_odut_defects_t *const defects)
{
    u32 target;
    u32 status;
 ...
 * ================================================================= */
static vtss_rc daytona_otn_och_perf_get(const vtss_port_no_t port_no, vtss_otn_och_perf_t *const perf)
{
    u32 target;
    u32 value = 0;
    ...
    if (vtss_state->otn_state[port_no].och_fec.type == VTSS_OTN_OCH_FEC_I4) {
        VTSS_RC(daytona_port_2_target(port_no, DAYTONA_BLOCK_EFECI4, &target));
    ...
    if (vtss_state->otn_state[port_no].och_fec.type == VTSS_OTN_OCH_FEC_I7) {
        VTSS_RC(daytona_port_2_target(port_no, DAYTONA_BLOCK_EFECI7, &target));
...
static vtss_rc daytona_otn_otu_perf_get(const vtss_port_no_t port_no, vtss_otn_otu_perf_t *const perf)
{
    u32 target;
    u32 value = 0;
...
static vtss_rc daytona_otn_odu_perf_get(const vtss_port_no_t port_no, vtss_otn_odu_perf_t *const perf)
{
    u32 target;
    u32 value = 0;
    u16 prbs_error = 0;
...
static vtss_rc daytona_otn_odut_perf_get(const vtss_port_no_t port_no, const u32 level, vtss_otn_odut_perf_t *const perf)
{
    u32 target;
    u32 value;
 ...
 *  Defects/Events
 * ================================================================= */
static vtss_rc daytona_otn_och_event_enable(const vtss_port_no_t port_no, const BOOL enable, const vtss_otn_och_event_t ev_mask)
{
    u32 target;
    u32 mask;
...
static vtss_rc daytona_otn_och_event_poll(const vtss_port_no_t port_no, vtss_otn_och_event_t *const status)
{
    u32 target;
...
static vtss_rc daytona_otn_och_event_poll_without_mask(const vtss_port_no_t port_no, vtss_otn_och_event_t *const status)
{
    u32 target;
...
static vtss_rc daytona_otn_otu_event_enable(const vtss_port_no_t port_no, const BOOL enable, const vtss_otn_otu_event_t ev_mask)
{
    u32 target;
    u32 mask;
...
static vtss_rc daytona_otn_otu_event_poll(const vtss_port_no_t port_no, vtss_otn_otu_event_t *const status)
{
    u32 target;
...
static vtss_rc daytona_otn_otu_event_poll_without_mask(const vtss_port_no_t port_no, vtss_otn_otu_event_t *const status)
{
    u32 target;
...
static vtss_rc daytona_otn_odu_event_enable(const vtss_port_no_t port_no, const BOOL enable, const vtss_otn_odu_event_t ev_mask)
{
    u32 target;
    u32 mask;
...
static vtss_rc daytona_otn_odu_event_poll(const vtss_port_no_t port_no, vtss_otn_odu_event_t *const status)
{
    u32 target;
...
static vtss_rc daytona_otn_odu_event_poll_without_mask(const vtss_port_no_t port_no, vtss_otn_odu_event_t *const status)
{
    u32 target;
...
static vtss_rc daytona_otn_odut_event_enable(const vtss_port_no_t port_no, const u32 level, const BOOL enable, const vtss_otn_odut_event_t ev_mask)
{
    u32 target;
    u32 mask;
...
static vtss_rc daytona_otn_odut_event_poll(const vtss_port_no_t port_no, const u32 level, vtss_otn_odut_event_t *const status)
{
    u32 target;
...
static vtss_rc daytona_otn_odut_event_poll_without_mask(const vtss_port_no_t port_no, const u32 level, vtss_otn_odut_event_t *const status)
{
    u32 target;
...
vtss_rc vtss_daytona_otn_restart_conf_set(void)
{
    u32 level;
    ...
    for (port_no = 0 ; port_no < vtss_state->port_count; port_no++) {
        rc = daytona_otn_och_loopback_set(port_no);
        rc = daytona_otn_och_fec_set(port_no, &(vtss_state->otn_state[port_no].och_fec));
        rc = daytona_otn_otu_tti_set(port_no);
        rc = daytona_otn_otu_ais_set(port_no);
        rc = daytona_otn_otu_consequent_actions_set(port_no);
        rc = daytona_otn_otu_oh_insertion_set(port_no);
        rc = daytona_otn_otu_tx_res_set(port_no);
        rc = daytona_otn_otu_tx_smres_set(port_no);
        rc = daytona_otn_otu_tx_gcc0_set(port_no);
        rc = daytona_otn_odu_mode_set(port_no);
        rc = daytona_otn_odu_tti_set(port_no);
        rc = daytona_otn_odu_ais_set(port_no);
        rc = daytona_otn_odu_consequent_actions_set(port_no);
        rc = daytona_otn_odu_oh_insertion_set(port_no);
        rc = daytona_otn_odu_tx_res_set(port_no);
        rc = daytona_otn_odu_tx_exp_set(port_no);
        rc = daytona_otn_odu_tx_ftfl_set(port_no);
        rc = daytona_otn_odu_tx_aps_set(port_no);
        rc = daytona_otn_odu_pt_set(port_no);
        rc = daytona_otn_odu_opu_oh_insertion_set(port_no);
        rc = daytona_otn_odu_opu_test_insertion_set(port_no);
        for (level=0; level<VTSS_OTN_ODUT_LEVEL_NUMBER; ++level) {
            rc = daytona_otn_odut_mode_set(port_no, level);
            rc = daytona_otn_odut_tti_set(port_no, level);
            rc = daytona_otn_odut_consequent_actions_set(port_no, level);
            rc = daytona_otn_odut_tx_stat_set(port_no, level);
            rc = daytona_otn_odut_tx_aps_set(port_no, level);
        }
 ...
 * \return Return code.
 **/
vtss_rc vtss_daytona_inst_otn_create(void)
{
