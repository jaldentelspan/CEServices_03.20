 ...
 * \return Return code.
 **/
static vtss_rc daytona_upi_config_set(const vtss_port_no_t port_no)
{
    u32 target;
 ...
 * \return Return code.
 **/
static vtss_rc daytona_upi_status_get(const vtss_port_no_t  port_no, vtss_upi_status_t *const status)
{
    u32 target;
    u32 upi_status;
 ...
 *        VTSS_RC_OK if ok.
 **/
static vtss_rc daytona_upi_test_config_set(const vtss_port_no_t port_no)
{
 ...
 * return Return code.
 */
static vtss_rc daytona_upi_test_status_get(const vtss_port_no_t  port_no, vtss_upi_test_status_t *const status)
{
    u32 target;
...
static vtss_rc daytona_upi_txeq_mode_set(const vtss_port_no_t port_no)
{
    u32 target; 
    u32 ntxpol;
...
static vtss_rc daytona_upi_txeq_coef_adjust(const vtss_port_no_t port_no,
...
static vtss_rc daytona_upi_txamp_set(const vtss_port_no_t port_no)
{
    u32 target;
...
static vtss_rc daytona_upi_txslew_set(const vtss_port_no_t port_no)
{
    u32 target;
...
static vtss_rc daytona_upi_rxeq_mode_set(const vtss_port_no_t port_no)
{
    u32 target;
 ...
 *  Defects/Events
 * ================================================================= */
static vtss_rc daytona_upi_event_enable(const vtss_port_no_t     port_no,
                                        const BOOL               enable,
...
static vtss_rc daytona_upi_event_poll(const vtss_port_no_t   port_no,
...
static vtss_rc daytona_upi_event_poll_without_mask(const vtss_port_no_t   port_no,
                                      vtss_upi_event_t       *const status)
{
    u32 target;
    u32 sticky;
...
vtss_rc vtss_daytona_upi_restart_conf_set(void)
{
    vtss_port_no_t port_no;
    vtss_rc rc;
    for (port_no = 0 ; port_no < vtss_state->port_count; port_no++) {
        rc = daytona_upi_config_set(port_no);
        rc = daytona_upi_test_config_set(port_no);
 ...
 * \return Return code.
 **/
vtss_rc vtss_daytona_inst_upi_create(void)
{
