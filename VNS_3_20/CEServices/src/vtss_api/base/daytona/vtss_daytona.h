...
vtss_rc vtss_daytona_inst_create(void);

vtss_rc vtss_daytona_blk_oper_mode_get(const vtss_port_no_t port_no, daytona_channel_t channel, block_name_t blk_name, u8 *blk_mode);
