 ...
 * \return Return code.
 **/
static vtss_rc daytona_xfi_config_set(const vtss_port_no_t port_no)
{
    u32 target;
    u32 reg_val=0;
    u32 reg_mask=0;
    ...
    VTSS_RC(daytona_port_2_target(port_no, DAYTONA_BLOCK_XFI, &target));
 ...
 * \return Return code.
 **/
static vtss_rc daytona_xfi_ae_reset(const vtss_port_no_t port_no,vtss_xfi_lane_t lane)
{
    u32 target;
    VTSS_RC(daytona_port_2_target(port_no, DAYTONA_BLOCK_XFI, &target));
 ...
 * \return Return code.
 **/
static vtss_rc daytona_xfi_recovered_clock_output_set(const vtss_port_no_t port_no)
{
    u32 target;
 ...
 * \return Return code.
 **/
static vtss_rc daytona_xfi_status_get(const vtss_port_no_t  port_no, vtss_xfi_status_t *const status)
{
    u32 target;
    u32 xfi_status;
    VTSS_RC(daytona_port_2_target(port_no, DAYTONA_BLOCK_XFI, &target));
 ...
 *        VTSS_RC_OK if ok.
 **/
static vtss_rc daytona_xfi_test_config_set(const vtss_port_no_t port_no)
{
    u32 target;
 ...
 * return Return code.
 */
static vtss_rc daytona_xfi_test_status_get(const vtss_port_no_t  port_no, vtss_xfi_test_status_t *const status)
{
    u32 target;
 ...
 *  Defects/Events
 * ================================================================= */
static vtss_rc daytona_xfi_event_enable(const vtss_port_no_t      port_no,
                                        const BOOL                enable,
...
static vtss_rc daytona_xfi_event_poll(const vtss_port_no_t  port_no,
...
static vtss_rc daytona_xfi_event_poll_without_mask(const vtss_port_no_t  port_no,
                                                   vtss_xfi_event_t      *const status)
{
    u32 target;
    u32 sticky;
...
static vtss_rc daytona_xfi_txeq_mode_set(const vtss_port_no_t port_no)
{
    u32 tgt;
    u32 ntxpol;

    VTSS_RC(daytona_port_2_target(port_no, DAYTONA_BLOCK_XFI, &tgt));
...
static vtss_rc daytona_xfi_txeq_coef_adjust(const vtss_port_no_t port_no,
...
static vtss_rc daytona_xfi_txamp_set(const vtss_port_no_t port_no)
{
    u32 tgt;
...
static vtss_rc daytona_xfi_txslew_set(const vtss_port_no_t port_no)
{
    u32 tgt;
...
static vtss_rc daytona_xfi_rxeq_mode_set(const vtss_port_no_t port_no)
{
    u32 tgt;
...
static vtss_rc daytona_xfi_txeq_8023ap_coef_update(const vtss_port_no_t port_no, vtss_xfi_lane_t lane, 
...
static vtss_rc daytona_xfi_txeq_8023ap_coef_stat_get(const vtss_port_no_t port_no, 
...
static vtss_rc daytona_xfi_txeq_8023ap_fsm_ctl_set(const vtss_port_no_t port_no, vtss_xfi_lane_t lane, u32 val)
{
    u32 tgt;
...
static vtss_rc daytona_xfi_txeq_8023ap_fsm_stat_get(const vtss_port_no_t port_no, vtss_xfi_lane_t lane, u32 *val)
{
    u32 tgt;
...
static vtss_xfi_tx_cfg_t tx_cfg_default = {
    ...
    .polarity                 = {[txeq_ffe_coef_0] = 1, [txeq_ffe_coef_2] = 1, [txeq_ffe_coef_2] = 1},
};
...
vtss_rc vtss_daytona_xfi_restart_conf_set(void)
{
    vtss_port_no_t port_no;
    vtss_rc rc;
    VTSS_D("xfi restart conf set, port_count %d", vtss_state->port_count);
    for (port_no = 0 ; port_no < vtss_state->port_count; port_no++) {
        rc = daytona_xfi_config_set(port_no);
        rc = daytona_xfi_test_config_set(port_no);
 ...
 * \return Return code.
 **/
vtss_rc vtss_daytona_inst_xfi_create(void)
{
    vtss_port_no_t port_no;
