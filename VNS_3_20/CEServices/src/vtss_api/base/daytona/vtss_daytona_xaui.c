...
static vtss_rc daytona_xaui_config_set(const vtss_port_no_t port_no)
{
    u32 target;
    VTSS_RC(daytona_port_2_target(port_no, DAYTONA_BLOCK_PCS_XAUI, &target));
 ...
 *  State Reporting
 * ================================================================= */
static vtss_rc daytona_xaui_status_get(const vtss_port_no_t port_no,
...
static vtss_rc daytona_xaui_counters_get(const vtss_port_no_t port_no,
...
static vtss_rc daytona_xaui_counters_clear(const vtss_port_no_t port_no)
{
    u32 target;
...
vtss_rc vtss_daytona_xaui_restart_conf_set(void)
{
    vtss_port_no_t port_no;
    vtss_rc rc;
    for (port_no = 0 ; port_no < vtss_state->port_count; port_no++) {
        rc = daytona_xaui_counters_clear(port_no);
        rc = daytona_xaui_config_set(port_no);
 ...
 * \return Return code.
 **/
vtss_rc vtss_daytona_inst_xaui_create(void)
{
