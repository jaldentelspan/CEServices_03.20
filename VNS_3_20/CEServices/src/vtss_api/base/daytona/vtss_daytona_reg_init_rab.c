...
#define RAB_TBL_SIZE   9
 static static_cfg_t rab_mac_tbl[9] = { {DAYTONA_BLOCK_RAB, VTSS_RAB_RAB_BASE_RAB_CONTROL(0), (VTSS_RAB_RAB_BASE_RAB_CONTROL_RX_CLK_ENA_MAC | VTSS_RAB_RAB_BASE_RAB_CONTROL_RX_BYPASS_SELECT_MAC | VTSS_RAB_RAB_BASE_RAB_CONTROL_TX_CLK_ENA_MAC | VTSS_RAB_RAB_BASE_RAB_CONTROL_TX_BYPASS_SELECT_MAC), (VTSS_M_RAB_RAB_BASE_RAB_CONTROL_RX_CLK_ENA | VTSS_M_RAB_RAB_BASE_RAB_CONTROL_RX_BYPASS_SELECT | VTSS_M_RAB_RAB_BASE_RAB_CONTROL_TX_CLK_ENA | VTSS_M_RAB_RAB_BASE_RAB_CONTROL_TX_BYPASS_SELECT)},
...
static static_cfg_t rab_gfp1_tbl[9] = { {DAYTONA_BLOCK_RAB, VTSS_RAB_RAB_BASE_RAB_CONTROL(0), (VTSS_RAB_RAB_BASE_RAB_CONTROL_RX_CLK_ENA_GFP1 | VTSS_RAB_RAB_BASE_RAB_CONTROL_RX_BYPASS_SELECT_GFP1 | VTSS_RAB_RAB_BASE_RAB_CONTROL_TX_CLK_ENA_GFP1 | VTSS_RAB_RAB_BASE_RAB_CONTROL_TX_BYPASS_SELECT_GFP1), (VTSS_M_RAB_RAB_BASE_RAB_CONTROL_RX_CLK_ENA | VTSS_M_RAB_RAB_BASE_RAB_CONTROL_RX_BYPASS_SELECT | VTSS_M_RAB_RAB_BASE_RAB_CONTROL_TX_CLK_ENA | VTSS_M_RAB_RAB_BASE_RAB_CONTROL_TX_BYPASS_SELECT)},
