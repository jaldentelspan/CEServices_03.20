                          ...
                          const vtss_i2c_cfg_t        *const cfg)
{
    ...
    if ((rc = vtss_inst_check(inst)) == VTSS_RC_OK) {
        rc = VTSS_FUNC_COLD(i2c_set_config, controller_cfg, cfg);
    }
    VTSS_EXIT();
    return rc;
}
                                ...
                                vtss_i2c_cfg_t        *const cfg)
{
    ...
    VTSS_ENTER();
    if ((rc = vtss_inst_check(inst)) == VTSS_RC_OK) {
        rc = VTSS_FUNC_COLD(i2c_get_config, controller_cfg, cfg);
    }
    VTSS_EXIT();
    return rc;
                          ...
                          u8                    *const data)
{
    ...
    VTSS_ENTER();
    if ((rc = vtss_inst_check(inst)) == VTSS_RC_OK) {
        rc = VTSS_FUNC_COLD(i2c_rx, controller_cfg, data);
    }
    VTSS_EXIT();
    return rc;
}
                    ...
                    const u8                    *const addr_data)
{
    ...
    VTSS_ENTER();
    if ((rc = vtss_inst_check(inst)) == VTSS_RC_OK) {
        rc = VTSS_FUNC_COLD(i2c_tx, controller_cfg, addr_data);
    }
    VTSS_EXIT();
    return rc;
                     ...
                     const u16                          cmd_flags)
{
    ...
    VTSS_ENTER();
    if ((rc = vtss_inst_check(inst)) == VTSS_RC_OK) {
        rc = VTSS_FUNC_COLD(i2c_cmd, controller_cfg, cmd_flags);
    }
    VTSS_EXIT();
    return rc;
                      ...
                      const vtss_i2c_controller_t *const controller_cfg)
{
    ...
    VTSS_ENTER();
    if ((rc = vtss_inst_check(inst)) == VTSS_RC_OK) {
        rc = VTSS_FUNC_COLD(i2c_stop, controller_cfg);
    }
    VTSS_EXIT();
    return rc;
                                  ...
                                  u16                   *const status)
{
    ...
    VTSS_ENTER();
    if ((rc = vtss_inst_check(inst)) == VTSS_RC_OK) {
        rc = VTSS_FUNC_COLD(i2c_get_status, controller_cfg, status);
    }
    VTSS_EXIT();
    return rc;
