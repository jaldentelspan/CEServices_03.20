...
#define PORT_CAP_10G_FDX           0x00000100 /* 5Gbps, full duplex */
...
/* Duo-speed port */
#define PORT_CAP_DUO_SPEED_FDX      (PORT_CAP_AUTONEG | PORT_CAP_100M_FDX | PORT_CAP_10M_FDX | PORT_CAP_FLOW_CTRL)
#define PORT_CAP_DUO_SPEED          (PORT_CAP_DUO_SPEED_FDX | PORT_CAP_HDX)
#define PORT_CAP_DUO_SPEED_COPPER   (PORT_CAP_DUO_SPEED | PORT_CAP_COPPER)
...
#define PORT_CAP_SFP_SD_HIGH (PORT_CAP_SD_ENABLE | PORT_CAP_SD_HIGH | PORT_CAP_SD_INTERNAL | PORT_CAP_SFP_DETECT)
...
typedef enum
{
    VTSS_SPEED_FIBER_NOT_SUPPORTED = 0, /**< Fiber not supported/ Fiber port disabled */
    VTSS_SPEED_FIBER_100FX = 2,       /**< 100BASE-FX*/
    VTSS_SPEED_FIBER_1000X = 3,       /**< 1000BASE-X*/
    VTSS_SPEED_FIBER_AUTO = 4,        /**< Auto detection*/
    VTSS_SPEED_FIBER_DISABLED = 5,    /**< Obsolete - use VTSS_SPEED_FIBER_NOT_SUPPORTED instead*/
...
typedef struct {
    ...
    vtss_fiber_port_speed_t fiber_speed;/* Speed for fiber ports*/
...
typedef enum {
    ...
    VTSS_BOARD_VNS_6_REF,
    VTSS_BOARD_VNS_8_REF,
    VTSS_BOARD_VNS_12_REF,
    VTSS_BOARD_NCGU_REF,
    VTSS_BOARD_IGU_REF,
    VTSS_BOARD_MITR_REF,
    VTSS_BOARD_VESM_REF,
    VTSS_BOARD_ESIR_REF,
    VTSS_BOARD_VNS_16_REF
} vtss_board_type_t;
...
int vtss_board_probe(vtss_board_info_t *board_info);

const char *vtss_board_name(void);

int vtss_board_type(void);
