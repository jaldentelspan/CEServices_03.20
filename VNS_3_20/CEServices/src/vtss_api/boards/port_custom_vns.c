...
#define BOARD_VNS_ALL_REF ((BOARD_VNS_6_REF) || (BOARD_VNS_8_REF) || (BOARD_VNS_12_REF) || (BOARD_VNS_16_REF))

#define VTSS_BOARD_VNS_ALL_REF (board_type == VTSS_BOARD_VNS_6_REF || board_type == VTSS_BOARD_VNS_8_REF || board_type == VTSS_BOARD_VNS_12_REF || board_type == VTSS_BOARD_VNS_16_REF)
...
#define IES_PORT_TABLE_CTRL_1_SGMII_CU( i, j, k) \
    lu26_port_table[i].map.chip_port = j; \
    lu26_port_table[i].map.miim_controller = VTSS_MIIM_CONTROLLER_1; \
    lu26_port_table[i].map.miim_addr = k; \
    lu26_port_table[i].mac_if = VTSS_PORT_INTERFACE_SGMII; \
    lu26_port_table[i].cap = PORT_CAP_TRI_SPEED_COPPER; \
    do {} while(0)
...
#define IES_PORT_TABLE_UPLINK_SERDES( i, j) \
    ...
    lu26_port_table[i].cap = PORT_CAP_1G_FDX | PORT_CAP_SFP_SD_HIGH; \
    do {} while(0)
...
static vtss_rc lu26_reset(void)
{
    ...
    // Call pre-reset (any port can be used)

    // Internal PHY
    if ((rc = vtss_phy_pre_reset(NULL, 0)) != VTSS_RC_OK) {
        return rc;
    }
    // External PHY (Atom12)
    rc = vtss_phy_pre_reset(NULL, 12);
...
#else
#error "Must declare a board ref"
#endif
    ...
    case VTSS_BOARD_LUTON10_REF:
        board->name = "Luton10";
        break;
    case VTSS_BOARD_VNS_6_REF:
        board->name = "VNS_6";
        break;
    case VTSS_BOARD_VNS_8_REF:
        board->name = "VNS_8";
        break;
    case VTSS_BOARD_VNS_12_REF:
        board->name = "VNS_12";
        break;
    case VTSS_BOARD_VNS_16_REF:
        board->name = "VNS_16";
        break;
    ...
    else if (board_type == VTSS_BOARD_VNS_16_REF ) 
    {
        IES_PORT_TABLE_CTRL_0_SGMII_CU(  0,  0 );
        IES_PORT_TABLE_CTRL_0_SGMII_CU(  1,  1 );
        IES_PORT_TABLE_CTRL_0_SGMII_CU(  2,  2 );
        ...
        IES_PORT_TABLE_CTRL_0_SGMII_CU( 10, 10 );
        IES_PORT_TABLE_CTRL_0_SGMII_CU( 11, 11 );
        IES_PORT_TABLE_CTRL_1_SGMII_CU( 12, 18, 0);
        IES_PORT_TABLE_CTRL_1_SGMII_CU( 13, 17, 1);
        IES_PORT_TABLE_CTRL_1_SGMII_CU( 14, 15, 2);
        IES_PORT_TABLE_CTRL_1_SGMII_CU( 15, 14, 3);
        port_idx = 15;
    }
    else if (board_type == VTSS_BOARD_VNS_6_REF ) 
    {
        IES_PORT_TABLE_CTRL_0_SGMII_CU( 0,  0 );
        IES_PORT_TABLE_CTRL_0_SGMII_CU( 1,  1 );
        IES_PORT_TABLE_CTRL_0_SGMII_CU( 2,  2 );
    ...
    else if (board_type == VTSS_BOARD_VNS_8_REF ) 
    {
        IES_PORT_TABLE_CTRL_0_SGMII_CU( 0,   0 );
        IES_PORT_TABLE_CTRL_0_SGMII_CU( 1,   1 );
        IES_PORT_TABLE_CTRL_0_SGMII_CU( 2,   2 );
        ...
        IES_PORT_TABLE_CTRL_0_SGMII_CU( 4,   8 );
        IES_PORT_TABLE_CTRL_0_SGMII_CU( 5,   9 );
        IES_PORT_TABLE_CTRL_0_SGMII_CU( 6,  10 );
        IES_PORT_TABLE_CTRL_0_SGMII_CU( 7,  11 );
        port_idx = 7;
    }
    else {
        return FALSE;
    ...
    /* UPLINK or FPGA connection */
    port_idx++;
    IES_PORT_TABLE_UPLINK_SERDES( port_idx, 20);
    port_idx++;
    IES_PORT_TABLE_UPLINK_SERDES( port_idx, 21);
    return TRUE;
}
