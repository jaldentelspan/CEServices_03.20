...
#define VTSS_QCL_IDS        (VTSS_PORTS)                     /**< Number of QCLs */
#else
...
/**
 * \brief Random Early Detection configuration struct
 **/
typedef struct
{
    ...
    u8         weight;          /**< Weight */
#endif
    vtss_pct_t max_prob_1;      /**< Maximum probability 1 */
    vtss_pct_t max_prob_2;      /**< Maximum probability 2 */
    vtss_pct_t max_prob_3;      /**< Maximum probability 3 */
} vtss_red_t;
...
typedef struct 
{
    ...
    vtss_vcap_u24_t smac;    /**< SMAC - The 24 most significant bits (OUI) of the MAC address */
} vtss_qce_mac_t;
...
typedef struct
{
...
#if defined(VTSS_FEATURE_QCL_V1)
    vtss_qce_type_t type;         /**< Entry type */
    ...
    union
    {
        ...
        } etype;                  /**< Type VTSS_QCE_TYPE_ETYPE */
                                
        struct                  
        {                       
            vtss_vid_t  vid;      /**< VLAN ID value */
            vtss_prio_t prio;     /**< Priority mapping */
        } vlan;                   /**< Type VTSS_QCE_TYPE_VLAN_ID */
        ...
        {                       
            ...
            vtss_prio_t    prio;  /**< Priority mapping */
        } udp_tcp;                /**< Type VTSS_QCE_TYPE_UDP_TCP */

        struct
        {
            vtss_dscp_t dscp_val; /**< DSCP value */
            vtss_prio_t prio;     /**< Priority mapping */
        } dscp;                   /**< Type VTSS_QCE_TYPE_DSCP */
        
        vtss_prio_t tos_prio[8];  /**< Type VTSS_QCE_TYPE_TOS -- ToS priority mapping */
        
        vtss_prio_t tag_prio[8];  /**< Type VTSS_QCE_TYPE_TAG -- Tag priority mapping */
    } frame; /**< Frame specific data */
#endif /* VTSS_FEATURE_QCL_V1 */
} vtss_qce_t;
