...
/* Pseudo target covering all targets */
#if defined(VTSS_CHIP_ALL)
#define VTSS_CHIP_E_STAX_34     /**< Enable E-StaX-34 features */
#define VTSS_CHIP_BARRINGTON_II /**< Enable Barrington-II features */
#endif /* VTSS_CHIP_ALL */

#if defined(VTSS_CHIP_SPARX_II_16) || defined(VTSS_CHIP_SPARX_II_24) || defined(VTSS_CHIP_E_STAX_34)
#define VTSS_ARCH_LUTON28                      /**< Luton28 architecture */
...
#define VTSS_FEATURE_VSTAX_V1                  /**< VStaX stacking, as implemented on Luton28 (VStaX2/BF) */
...
#define VTSS_FEATURE_QOS_DSCP_REMARK_V1        /**< QoS: DSCP remarking as implemented on Luton28 */
#define VTSS_FEATURE_QOS_TAG_REMARK            /**< QoS: Tag priority remarking */
#define VTSS_FEATURE_QCL                       /**< QoS: QoS Control Lists */
#define VTSS_FEATURE_QCL_V1                    /**< QoS: QoS Control Lists, V1 features */
...
#define VTSS_FEATURE_ACL_V1                    /**< Access Control Lists, V1 features */
...
#define VTSS_FEATURE_VLAN_PORT_V1              /**< VLAN port configuration, V1 features */
#define VTSS_FEATURE_MAC_AGE_AUTO              /**< Automatic MAC address ageing */
#if !defined(VTSS_OPT_VCORE_II)
#define VTSS_OPT_VCORE_II 1                    /**< Internal VCore-II (ARM) CPU enabled by default */
#endif
#if defined(VTSS_OPT_VCORE_II) && (VTSS_OPT_VCORE_II != 0)
#define VTSS_FEATURE_FDMA                      /**< Frame DMA */
#endif
#endif /* VTSS_CHIP_SPARX_II_16/SPARX_II_24/E_STAX_34 */
...
#define VTSS_FEATURE_QOS_WRED                  /**< QoS: WRED */
#define VTSS_FEATURE_INTERRUPTS                /**< Interrupt support */
...
#if defined(VTSS_CHIP_LYNX_1) || defined(VTSS_CHIP_JAGUAR_1) || defined(VTSS_CHIP_JAGUAR_1_DUAL)
...
/**< Jaguar-1 dual chip switches */
    ...
    defined(VTSS_CHIP_JAGUAR_1_DUAL)           /**< Dual Jaguar-1 architecture */
#define VTSS_ARCH_JAGUAR_1_DUAL
#endif /* E_STAX_III_48_DUAL/E_STAX_III_68_DUAL/JAGUAR_1_DUAL */
...
#define VTSS_FEATURE_QOS_WRED                  /**< QoS: WRED (Jaguar and Barrington-II) */
#define VTSS_FEATURE_PACKET                    /**< CPU Rx/Tx frame */
...
/* Now enable FDMA sub-options. */
  ...
  /**< Use of VTSS_OPT_FDMA_VER is the preferred way to indicate which version of the FDMA API is required */
    ...
    #ifdef VTSS_OPT_FDMA_V2 /* Use of this to select a particular FDMA version is deprecated */
      #define VTSS_OPT_FDMA_VER 2 /**< When V2 is defined, use version 2 */
    #else
      #ifdef VTSS_ARCH_LUTON28
        #define VTSS_OPT_FDMA_VER 1 /**< This is the default legacy mode for Lu28. */
      #else
        #define VTSS_OPT_FDMA_VER 2 /**< This is the default legacy mode for non-Lu28 chips */
      #endif
    #endif
  #endif
...
#define VTSS_OPT_REF_CLK_SINGLE_ENDED 1 /**< Single ended clock by default */
#endif /* VTSS_OPT_REF_CLK_SINGLE_ENDED */

/* Shared UART/GPIO pins in UART mode */
#if defined(VTSS_OPT_VCORE_II) && (VTSS_OPT_VCORE_II != 0) && !defined(VTSS_OPT_UART)
#define VTSS_OPT_UART 1 /**< UART enabled by default */
#endif /* VTSS_OPT_UART */
