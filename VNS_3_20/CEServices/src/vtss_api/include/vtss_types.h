...
/* 23x1G + 4x2.5G + 1x10G + NPI on each device (port mux mode 1) */
#if defined(VTSS_CHIP_JAGUAR_1_DUAL)
#if (VTSS_PORT_COUNT < 58)
#undef VTSS_PORT_COUNT
#define VTSS_PORT_COUNT 58 /**< Number of ports */
#endif /* VTSS_PORT_COUNT < 58 */
#endif /* VTSS_CHIP_JAGUAR_1_DUAL */
...
#endif /* VTSS_ARCH_B2 || defined(VTSS_ARCH_JAGUAR_1) || VTSS_ARCH_LUTON26 */
