...
typedef enum {
    ...
    VTSS_TARGET_JAGUAR_1_DUAL      = 0xD7460, /**< Dual Jaguar-1 CE switch */
 ...
 * \return Return code.
 **/
typedef vtss_rc (*vtss_miim_read_t)(const vtss_port_no_t port_no,
                                    const u8             addr,
                                    u16                  *const value);
 ...
 * \return Return code.
 **/
typedef vtss_rc (*vtss_miim_write_t)(const vtss_port_no_t port_no,
                                     const u8             addr,
                                     const u16            value);
 ...
 * \return Return code.
 **/
typedef vtss_rc (*vtss_mmd_read_t)(const vtss_port_no_t port_no,
                                   const u8             mmd,
                                   const u16             addr,
                                   u16                  *const value);
 ...
 * \return Return code.
 **/
typedef vtss_rc (*vtss_mmd_read_inc_t)(const vtss_port_no_t port_no,
                                     const u8             mmd,
                                     const u16            addr,
                                     u16                  *const buf,
                                     u8                   count);
 ...
 * \return Return code.
 **/
typedef vtss_rc (*vtss_mmd_write_t)(const vtss_port_no_t port_no,
                                    const u8             mmd,
                                    const u16            addr,
                                    const u16            value);
