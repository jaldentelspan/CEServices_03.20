...
typedef struct {
    ...
    vtss_mpls_tc_to_qos_map_entry_t  tc_to_qos_map[VTSS_MPLS_TC_TO_QOS_MAP_CNT][VTSS_MPLS_TC_TO_QOS_ENTRY_CNT];
} vtss_mpls_tc_conf_t;
...
typedef struct {
    ...
    vtss_mpls_idxchain_t        users;          /**< [RO] Chain of segments using this L2, or VTSS_MPLS_IDXCHAIN_UNDEFINED for none */
} vtss_mpls_l2_t;
 ...
 *
 * All indices are VTSS_MPLS_IDX_UNDEFINED if unused/uninitialized; index chain
 * starts out with VTSS_MPLS_IDXCHAIN_UNDEFINED.
 *  */
typedef struct {
    ...
    vtss_mpls_idxchain_t        clients;             /**< [RO] Chain of segments using this segment as server */
} vtss_mpls_segment_t;
...
typedef struct {
    ...
    vtss_mpls_idxchain_t        mc_chain;                   /**< [RO] Multicast chain */
#if 0
...
/** \brief Initialize global idxchain data structure. */
